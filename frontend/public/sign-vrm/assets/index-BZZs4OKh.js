...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Cs(e,t,n){let r=new Float32Array(ls),i=new U(0,1,0);return new xa({name:`SphericalGaussianBlur`,defines:{n:ls,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Es(),fragmentShader:`
...
`,Ep={None:`none`,Normal:`normal`,LitShadeRate:`litShadeRate`,UV:`uv`},Dp={None:`none`,WorldCoordinates:`worldCoordinates`,ScreenCoordinates:`screenCoordinates`};function Op(e){return e.colorSpace}var kp=class extends xa{constructor(e={}){super({vertexShader:wp,fragmentShader:Tp}),this.uvAnimationScrollXSpeedFactor=0,this.uvAnimationScrollYSpeedFactor=0,this.uvAnimationRotationSpeedFactor=0,this.fog=!0,this.normalMapType=0,this._ignoreVertexColor=!0,this._v0CompatShade=!1,this._debugMode=Ep.None,this._outlineWidthMode=Dp.None,this._isOutline=!1,e.transparentWithZWrite&&(e.depthWrite=!0),delete e.transparentWithZWrite,e.fog=!0,e.lights=!0,e.clipping=!0,this.uniforms=va.merge([Y.common,Y.normalmap,Y.emissivemap,Y.fog,Y.lights,{litFactor:{value:new q(1,1,1)},mapUvTransform:{value:new W},colorAlpha:{value:1},normalMapUvTransform:{value:new W},shadeColorFactor:{value:new q(0,0,0)},shadeMultiplyTexture:{value:null},shadeMultiplyTextureUvTransform:{value:new W},shadingShiftFactor:{value:0},shadingShiftTexture:{value:null},shadingShiftTextureUvTransform:{value:new W},shadingShiftTextureScale:{value:1},shadingToonyFactor:{value:.9},giEqualizationFactor:{value:.9},matcapFactor:{value:new q(1,1,1)},matcapTexture:{value:null},matcapTextureUvTransform:{value:new W},parametricRimColorFactor:{value:new q(0,0,0)},rimMultiplyTexture:{value:null},rimMultiplyTextureUvTransform:{value:new W},rimLightingMixFactor:{value:1},parametricRimFresnelPowerFactor:{value:5},parametricRimLiftFactor:{value:0},emissive:{value:new q(0,0,0)},emissiveIntensity:{value:1},emissiveMapUvTransform:{value:new W},outlineWidthMultiplyTexture:{value:null},outlineWidthMultiplyTextureUvTransform:{value:new W},outlineWidthFactor:{value:0},outlineColorFactor:{value:new q(0,0,0)},outlineLightingMixFactor:{value:1},uvAnimationMaskTexture:{value:null},uvAnimationMaskTextureUvTransform:{value:new W},uvAnimationScrollXOffset:{value:0},uvAnimationScrollYOffset:{value:0},uvAnimationRotationPhase:{value:0}},e.uniforms??{}]),this.setValues(e),this._uploadUniformsWorkaround(),this.customProgramCacheKey=()=>[...Object.entries(this._generateDefines()).map(([e,t])=>`${e}:${t}`),this.matcapTexture?`matcapTextureColorSpace:${Op(this.matcapTexture)}`:``,this.shadeMultiplyTexture?`shadeMultiplyTextureColorSpace:${Op(this.shadeMultiplyTexture)}`:``,this.rimMultiplyTexture?`rimMultiplyTextureColorSpace:${Op(this.rimMultiplyTexture)}`:``].join(`,`),this.onBeforeCompile=e=>{let t=Object.entries(bp(bp({},this._generateDefines()),this.defines)).filter(([e,t])=>!!t).map(([e,t])=>`#define ${e} ${t}`).join(`
`)+`
`;e.vertexShader=t+e.vertexShader,e.fragmentShader=t+e.fragmentShader}}get color(){return this.uniforms.litFactor.value}set color(e){this.uniforms.litFactor.value=e}get map(){return this.uniforms.map.value}set map(e){this.uniforms.map.value=e}get normalMap(){return this.uniforms.normalMap.value}set normalMap(e){this.uniforms.normalMap.value=e}get normalScale(){return this.uniforms.normalScale.value}set normalScale(e){this.uniforms.normalScale.value=e}get emissive(){return this.uniforms.emissive.value}set emissive(e){this.uniforms.emissive.value=e}get emissiveIntensity(){return this.uniforms.emissiveIntensity.value}set emissiveIntensity(e){this.uniforms.emissiveIntensity.value=e}get emissiveMap(){return this.uniforms.emissiveMap.value}set emissiveMap(e){this.uniforms.emissiveMap.value=e}get shadeColorFactor(){return this.uniforms.shadeColorFactor.value}set shadeColorFactor(e){this.uniforms.shadeColorFactor.value=e}get shadeMultiplyTexture(){return this.uniforms.shadeMultiplyTexture.value}set shadeMultiplyTexture(e){this.uniforms.shadeMultiplyTexture.value=e}get shadingShiftFactor(){return this.uniforms.shadingShiftFactor.value}set shadingShiftFactor(e){this.uniforms.shadingShiftFactor.value=e}get shadingShiftTexture(){return this.uniforms.shadingShiftTexture.value}set shadingShiftTexture(e){this.uniforms.shadingShiftTexture.value=e}get shadingShiftTextureScale(){return this.uniforms.shadingShiftTextureScale.value}set shadingShiftTextureScale(e){this.uniforms.shadingShiftTextureScale.value=e}get shadingToonyFactor(){return this.uniforms.shadingToonyFactor.value}set shadingToonyFactor(e){this.uniforms.shadingToonyFactor.value=e}get giEqualizationFactor(){return this.uniforms.giEqualizationFactor.value}set giEqualizationFactor(e){this.uniforms.giEqualizationFactor.value=e}get matcapFactor(){return this.uniforms.matcapFactor.value}set matcapFactor(e){this.uniforms.matcapFactor.value=e}get matcapTexture(){return this.uniforms.matcapTexture.value}set matcapTexture(e){this.uniforms.matcapTexture.value=e}get parametricRimColorFactor(){return this.uniforms.parametricRimColorFactor.value}set parametricRimColorFactor(e){this.uniforms.parametricRimColorFactor.value=e}get rimMultiplyTexture(){return this.uniforms.rimMultiplyTexture.value}set rimMultiplyTexture(e){this.uniforms.rimMultiplyTexture.value=e}get rimLightingMixFactor(){return this.uniforms.rimLightingMixFactor.value}set rimLightingMixFactor(e){this.uniforms.rimLightingMixFactor.value=e}get parametricRimFresnelPowerFactor(){return this.uniforms.parametricRimFresnelPowerFactor.value}set parametricRimFresnelPowerFactor(e){this.uniforms.parametricRimFresnelPowerFactor.value=e}get parametricRimLiftFactor(){return this.uniforms.parametricRimLiftFactor.value}set parametricRimLiftFactor(e){this.uniforms.parametricRimLiftFactor.value=e}get outlineWidthMultiplyTexture(){return this.uniforms.outlineWidthMultiplyTexture.value}set outlineWidthMultiplyTexture(e){this.uniforms.outlineWidthMultiplyTexture.value=e}get outlineWidthFactor(){return this.uniforms.outlineWidthFactor.value}set outlineWidthFactor(e){this.uniforms.outlineWidthFactor.value=e}get outlineColorFactor(){return this.uniforms.outlineColorFactor.value}set outlineColorFactor(e){this.uniforms.outlineColorFactor.value=e}get outlineLightingMixFactor(){return this.uniforms.outlineLightingMixFactor.value}set outlineLightingMixFactor(e){this.uniforms.outlineLightingMixFactor.value=e}get uvAnimationMaskTexture(){return this.uniforms.uvAnimationMaskTexture.value}set uvAnimationMaskTexture(e){this.uniforms.uvAnimationMaskTexture.value=e}get uvAnimationScrollXOffset(){return this.uniforms.uvAnimationScrollXOffset.value}set uvAnimationScrollXOffset(e){this.uniforms.uvAnimationScrollXOffset.value=e}get uvAnimationScrollYOffset(){return this.uniforms.uvAnimationScrollYOffset.value}set uvAnimationScrollYOffset(e){this.uniforms.uvAnimationScrollYOffset.value=e}get uvAnimationRotationPhase(){return this.uniforms.uvAnimationRotationPhase.value}set uvAnimationRotationPhase(e){this.uniforms.uvAnimationRotationPhase.value=e}get ignoreVertexColor(){return this._ignoreVertexColor}set ignoreVertexColor(e){this._ignoreVertexColor=e,this.needsUpdate=!0}get v0CompatShade(){return this._v0CompatShade}set v0CompatShade(e){this._v0CompatShade=e,this.needsUpdate=!0}get debugMode(){return this._debugMode}set debugMode(e){this._debugMode=e,this.needsUpdate=!0}get outlineWidthMode(){return this._outlineWidthMode}set outlineWidthMode(e){this._outlineWidthMode=e,this.needsUpdate=!0}get isOutline(){return this._isOutline}set isOutline(e){this._isOutline=e,this.needsUpdate=!0}get isMToonMaterial(){return!0}update(e){this._uploadUniformsWorkaround(),this._updateUVAnimation(e)}copy(e){return super.copy(e),this.map=e.map,this.normalMap=e.normalMap,this.emissiveMap=e.emissiveMap,this.shadeMultiplyTexture=e.shadeMultiplyTexture,this.shadingShiftTexture=e.shadingShiftTexture,this.matcapTexture=e.matcapTexture,this.rimMultiplyTexture=e.rimMultiplyTexture,this.outlineWidthMultiplyTexture=e.outlineWidthMultiplyTexture,this.uvAnimationMaskTexture=e.uvAnimationMaskTexture,this.normalMapType=e.normalMapType,this.uvAnimationScrollXSpeedFactor=e.uvAnimationScrollXSpeedFactor,this.uvAnimationScrollYSpeedFactor=e.uvAnimationScrollYSpeedFactor,this.uvAnimationRotationSpeedFactor=e.uvAnimationRotationSpeedFactor,this.ignoreVertexColor=e.ignoreVertexColor,this.v0CompatShade=e.v0CompatShade,this.debugMode=e.debugMode,this.outlineWidthMode=e.outlineWidthMode,this.isOutline=e.isOutline,this.needsUpdate=!0,this}_updateUVAnimation(e){this.uniforms.uvAnimationScrollXOffset.value+=e*this.uvAnimationScrollXSpeedFactor,this.uniforms.uvAnimationScrollYOffset.value+=e*this.uvAnimationScrollYSpeedFactor,this.uniforms.uvAnimationRotationPhase.value+=e*this.uvAnimationRotationSpeedFactor,this.uniforms.alphaTest.value=this.alphaTest,this.uniformsNeedUpdate=!0}_uploadUniformsWorkaround(){this.uniforms.opacity.value=this.opacity,this._updateTextureMatrix(this.uniforms.map,this.uniforms.mapUvTransform),this._updateTextureMatrix(this.uniforms.normalMap,this.uniforms.normalMapUvTransform),this._updateTextureMatrix(this.uniforms.emissiveMap,this.uniforms.emissiveMapUvTransform),this._updateTextureMatrix(this.uniforms.shadeMultiplyTexture,this.uniforms.shadeMultiplyTextureUvTransform),this._updateTextureMatrix(this.uniforms.shadingShiftTexture,this.uniforms.shadingShiftTextureUvTransform),this._updateTextureMatrix(this.uniforms.matcapTexture,this.uniforms.matcapTextureUvTransform),this._updateTextureMatrix(this.uniforms.rimMultiplyTexture,this.uniforms.rimMultiplyTextureUvTransform),this._updateTextureMatrix(this.uniforms.outlineWidthMultiplyTexture,this.uniforms.outlineWidthMultiplyTextureUvTransform),this._updateTextureMatrix(this.uniforms.uvAnimationMaskTexture,this.uniforms.uvAnimationMaskTextureUvTransform),this.uniformsNeedUpdate=!0}_generateDefines(){let e=this.outlineWidthMultiplyTexture!==null,t=this.map!==null||this.normalMap!==null||this.emissiveMap!==null||this.shadeMultiplyTexture!==null||this.shadingShiftTexture!==null||this.rimMultiplyTexture!==null||this.uvAnimationMaskTexture!==null;return{THREE_VRM_THREE_REVISION:184,OUTLINE:this._isOutline,MTOON_USE_UV:e||t,MTOON_UVS_VERTEX_ONLY:e&&!t,V0_COMPAT_SHADE:this._v0CompatShade,USE_SHADEMULTIPLYTEXTURE:this.shadeMultiplyTexture!==null,USE_SHADINGSHIFTTEXTURE:this.shadingShiftTexture!==null,USE_MATCAPTEXTURE:this.matcapTexture!==null,USE_RIMMULTIPLYTEXTURE:this.rimMultiplyTexture!==null,USE_OUTLINEWIDTHMULTIPLYTEXTURE:this._isOutline&&this.outlineWidthMultiplyTexture!==null,USE_UVANIMATIONMASKTEXTURE:this.uvAnimationMaskTexture!==null,IGNORE_VERTEX_COLOR:this._ignoreVertexColor===!0,DEBUG_NORMAL:this._debugMode===`normal`,DEBUG_LITSHADERATE:this._debugMode===`litShadeRate`,DEBUG_UV:this._debugMode===`uv`,OUTLINE_WIDTH_SCREEN:this._isOutline&&this._outlineWidthMode===Dp.ScreenCoordinates}}_updateTextureMatrix(e,t){e.value&&(e.value.matrixAutoUpdate&&e.value.updateMatrix(),t.value.copy(e.value.matrix))}},Ap=new Set([`1.0`,`1.0-beta`]),jp=class e{get name(){return e.EXTENSION_NAME}constructor(e,t={}){this.parser=e,this.materialType=t.materialType??kp,this.renderOrderOffset=t.renderOrderOffset??0,this.v0CompatShade=t.v0CompatShade??!1,this.debugMode=t.debugMode??`none`,this._mToonMaterialSet=new Set}beforeRoot(){return xp(this,null,function*(){this._removeUnlitExtensionIfMToonExists()})}afterRoot(e){return xp(this,null,function*(){e.userData.vrmMToonMaterials=Array.from(this._mToonMaterialSet)})}getMaterialType(e){return this._getMToonExtension(e)?this.materialType:null}extendMaterialParams(e,t){let n=this._getMToonExtension(e);return n?this._extendMaterialParams(n,t):null}loadMesh(e){return xp(this,null,function*(){let t=this.parser,n=t.json.meshes?.[e];if(n==null)throw Error(`MToonMaterialLoaderPlugin: Attempt to use meshes[${e}] of glTF but the mesh doesn't exist`);let r=n.primitives,i=yield t.loadMesh(e);if(r.length===1){let e=i,t=r[0].material;t!=null&&this._setupPrimitive(e,t)}else{let e=i;for(let t=0;t<r.length;t++){let n=e.children[t],i=r[t].material;i!=null&&this._setupPrimitive(n,i)}}return i})}_removeUnlitExtensionIfMToonExists(){this.parser.json.materials?.map((e,t)=>{this._getMToonExtension(t)&&e.extensions?.KHR_materials_unlit&&delete e.extensions.KHR_materials_unlit})}_getMToonExtension(t){let n=this.parser.json.materials?.[t];if(n==null){console.warn(`MToonMaterialLoaderPlugin: Attempt to use materials[${t}] of glTF but the material doesn't exist`);return}let r=n.extensions?.[e.EXTENSION_NAME];if(r==null)return;let i=r.specVersion;if(!Ap.has(i)){console.warn(`MToonMaterialLoaderPlugin: Unknown ${e.EXTENSION_NAME} specVersion "${i}"`);return}return r}_extendMaterialParams(e,t){return xp(this,null,function*(){delete t.metalness,delete t.roughness;let n=new Cp(this.parser,t);n.assignPrimitive(`transparentWithZWrite`,e.transparentWithZWrite),n.assignColor(`shadeColorFactor`,e.shadeColorFactor),n.assignTexture(`shadeMultiplyTexture`,e.shadeMultiplyTexture,!0),n.assignPrimitive(`shadingShiftFactor`,e.shadingShiftFactor),n.assignTexture(`shadingShiftTexture`,e.shadingShiftTexture,!0),n.assignPrimitive(`shadingShiftTextureScale`,e.shadingShiftTexture?.scale),n.assignPrimitive(`shadingToonyFactor`,e.shadingToonyFactor),n.assignPrimitive(`giEqualizationFactor`,e.giEqualizationFactor),n.assignColor(`matcapFactor`,e.matcapFactor),n.assignTexture(`matcapTexture`,e.matcapTexture,!0),n.assignColor(`parametricRimColorFactor`,e.parametricRimColorFactor),n.assignTexture(`rimMultiplyTexture`,e.rimMultiplyTexture,!0),n.assignPrimitive(`rimLightingMixFactor`,e.rimLightingMixFactor),n.assignPrimitive(`parametricRimFresnelPowerFactor`,e.parametricRimFresnelPowerFactor),n.assignPrimitive(`parametricRimLiftFactor`,e.parametricRimLiftFactor),n.assignPrimitive(`outlineWidthMode`,e.outlineWidthMode),n.assignPrimitive(`outlineWidthFactor`,e.outlineWidthFactor),n.assignTexture(`outlineWidthMultiplyTexture`,e.outlineWidthMultiplyTexture,!1),n.assignColor(`outlineColorFactor`,e.outlineColorFactor),n.assignPrimitive(`outlineLightingMixFactor`,e.outlineLightingMixFactor),n.assignTexture(`uvAnimationMaskTexture`,e.uvAnimationMaskTexture,!1),n.assignPrimitive(`uvAnimationScrollXSpeedFactor`,e.uvAnimationScrollXSpeedFactor),n.assignPrimitive(`uvAnimationScrollYSpeedFactor`,e.uvAnimationScrollYSpeedFactor),n.assignPrimitive(`uvAnimationRotationSpeedFactor`,e.uvAnimationRotationSpeedFactor),n.assignPrimitive(`v0CompatShade`,this.v0CompatShade),n.assignPrimitive(`debugMode`,this.debugMode),yield n.pending})}_setupPrimitive(e,t){let n=this._getMToonExtension(t);if(n){e.renderOrder=this._parseRenderOrder(n)+this.renderOrderOffset,this._generateOutline(e),this._addToMaterialSet(e);return}}_shouldGenerateOutline(e){return typeof e.outlineWidthMode==`string`&&e.outlineWidthMode!==`none`&&typeof e.outlineWidthFactor==`number`&&e.outlineWidthFactor>0}_generateOutline(e){let t=e.material;if(!(t instanceof Ir)||!this._shouldGenerateOutline(t))return;e.material=[t];let n=t.clone();n.name+=` (Outline)`,n.isOutline=!0,n.side=1,e.material.push(n);let r=e.geometry,i=r.index?r.index.count:r.attributes.position.count/3;r.addGroup(0,i,0),r.addGroup(0,i,1)}_addToMaterialSet(e){let t=e.material,n=new Set;Array.isArray(t)?t.forEach(e=>n.add(e)):n.add(t);for(let e of n)this._mToonMaterialSet.add(e)}_parseRenderOrder(e){return(e.transparentWithZWrite?0:19)+(e.renderQueueOffsetNumber??0)}};jp.EXTENSION_NAME=`VRMC_materials_mtoon`;var Mp=jp,Np=(e,t,n)=>new Promise((r,i)=>{var a=e=>{try{s(n.next(e))}catch(e){i(e)}},o=e=>{try{s(n.throw(e))}catch(e){i(e)}},s=e=>e.done?r(e.value):Promise.resolve(e.value).then(a,o);s((n=n.apply(e,t)).next())}),Pp=class e{get name(){return e.EXTENSION_NAME}constructor(e){this.parser=e}extendMaterialParams(e,t){return Np(this,null,function*(){let n=this._getHDREmissiveMultiplierExtension(e);n!=null&&(console.warn("VRMMaterialsHDREmissiveMultiplierLoaderPlugin: `VRMC_materials_hdr_emissiveMultiplier` is archived. Use `KHR_materials_emissive_strength` instead."),t.emissiveIntensity=n.emissiveMultiplier)})}_getHDREmissiveMultiplierExtension(t){let n=this.parser.json.materials?.[t];if(n==null){console.warn(`VRMMaterialsHDREmissiveMultiplierLoaderPlugin: Attempt to use materials[${t}] of glTF but the material doesn't exist`);return}let r=n.extensions?.[e.EXTENSION_NAME];if(r!=null)return r}};Pp.EXTENSION_NAME=`VRMC_materials_hdr_emissiveMultiplier`;var Fp=Pp,Ip=Object.defineProperty,Lp=Object.defineProperties,Rp=Object.getOwnPropertyDescriptors,zp=Object.getOwnPropertySymbols,Bp=Object.prototype.hasOwnProperty,Vp=Object.prototype.propertyIsEnumerable,Hp=(e,t,n)=>t in e?Ip(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,Up=(e,t)=>{for(var n in t||={})Bp.call(t,n)&&Hp(e,n,t[n]);if(zp)for(var n of zp(t))Vp.call(t,n)&&Hp(e,n,t[n]);return e},Wp=(e,t)=>Lp(e,Rp(t)),Gp=(e,t,n)=>new Promise((r,i)=>{var a=e=>{try{s(n.next(e))}catch(e){i(e)}},o=e=>{try{s(n.throw(e))}catch(e){i(e)}},s=e=>e.done?r(e.value):Promise.resolve(e.value).then(a,o);s((n=n.apply(e,t)).next())});function Kp(e){return e**2.2}var qp=class{get name(){return`VRMMaterialsV0CompatPlugin`}constructor(e){this.parser=e,this._renderQueueMapTransparent=new Map,this._renderQueueMapTransparentZWrite=new Map;let t=this.parser.json;t.extensionsUsed=t.extensionsUsed??[],t.extensionsUsed.indexOf(`KHR_texture_transform`)===-1&&t.extensionsUsed.push(`KHR_texture_transform`)}beforeRoot(){return Gp(this,null,function*(){let e=this.parser.json,t=e.extensions?.VRM?.materialProperties;t&&(this._populateRenderQueueMap(t),t.forEach((t,n)=>{let r=e.materials?.[n];if(r==null){console.warn(`VRMMaterialsV0CompatPlugin: Attempt to use materials[${n}] of glTF but the material doesn't exist`);return}if(t.shader===`VRM/MToon`){let i=this._parseV0MToonProperties(t,r);e.materials[n]=i}else if(t.shader?.startsWith(`VRM/Unlit`)){let i=this._parseV0UnlitProperties(t,r);e.materials[n]=i}else t.shader===`VRM_USE_GLTFSHADER`||console.warn(`VRMMaterialsV0CompatPlugin: Unknown shader: ${t.shader}`)}))})}_parseV0MToonProperties(e,t){let n=e.keywordMap?._ALPHABLEND_ON??!1,r=e.floatProperties?._ZWrite===1&&n,i=this._v0ParseRenderQueue(e),a=e.keywordMap?._ALPHATEST_ON??!1,o=n?`BLEND`:a?`MASK`:`OPAQUE`,s=a?e.floatProperties?._Cutoff??.5:void 0,c=(e.floatProperties?._CullMode??2)===0,l=this._portTextureTransform(e),u=(e.vectorProperties?._Color??[1,1,1,1]).map((e,t)=>t===3?e:Kp(e)),d=e.textureProperties?._MainTex,f=d==null?void 0:{index:d,extensions:Up({},l)},p=e.floatProperties?._BumpScale??1,m=e.textureProperties?._BumpMap,h=m==null?void 0:{index:m,scale:p,extensions:Up({},l)},g=(e.vectorProperties?._EmissionColor??[0,0,0,1]).map(Kp),_=e.textureProperties?._EmissionMap,v=_==null?void 0:{index:_,extensions:Up({},l)},y=(e.vectorProperties?._ShadeColor??[.97,.81,.86,1]).map(Kp),b=e.textureProperties?._ShadeTexture,x=b==null?void 0:{index:b,extensions:Up({},l)},S=e.floatProperties?._ShadeShift??0,C=e.floatProperties?._ShadeToony??.9;C=Nt.lerp(C,1,.5+.5*S),S=-S-(1-C);let w=e.floatProperties?._IndirectLightIntensity??.1,T=w?1-w:void 0,E=e.textureProperties?._SphereAdd,D=E==null?void 0:[1,1,1],O=E==null?void 0:{index:E},k=e.floatProperties?._RimLightingMix??0,A=e.textureProperties?._RimTexture,ee=A==null?void 0:{index:A,extensions:Up({},l)},te=(e.vectorProperties?._RimColor??[0,0,0,1]).map(Kp),j=e.floatProperties?._RimFresnelPower??1,ne=e.floatProperties?._RimLift??0,re=[`none`,`worldCoordinates`,`screenCoordinates`][e.floatProperties?._OutlineWidthMode??0],M=e.floatProperties?._OutlineWidth??0;M=.01*M;let ie=e.textureProperties?._OutlineWidthTexture,ae=ie==null?void 0:{index:ie,extensions:Up({},l)},oe=(e.vectorProperties?._OutlineColor??[0,0,0]).map(Kp),se=(e.floatProperties?._OutlineColorMode??0)===1?e.floatProperties?._OutlineLightingMix??1:0,N=e.textureProperties?._UvAnimMaskTexture,ce=N==null?void 0:{index:N,extensions:Up({},l)},le=e.floatProperties?._UvAnimScrollX??0,ue=e.floatProperties?._UvAnimScrollY??0;ue!=null&&(ue=-ue);let de=e.floatProperties?._UvAnimRotation??0,fe={specVersion:`1.0`,transparentWithZWrite:r,renderQueueOffsetNumber:i,shadeColorFactor:y,shadeMultiplyTexture:x,shadingShiftFactor:S,shadingToonyFactor:C,giEqualizationFactor:T,matcapFactor:D,matcapTexture:O,rimLightingMixFactor:k,rimMultiplyTexture:ee,parametricRimColorFactor:te,parametricRimFresnelPowerFactor:j,parametricRimLiftFactor:ne,outlineWidthMode:re,outlineWidthFactor:M,outlineWidthMultiplyTexture:ae,outlineColorFactor:oe,outlineLightingMixFactor:se,uvAnimationMaskTexture:ce,uvAnimationScrollXSpeedFactor:le,uvAnimationScrollYSpeedFactor:ue,uvAnimationRotationSpeedFactor:de};return Wp(Up({},t),{pbrMetallicRoughness:{baseColorFactor:u,baseColorTexture:f},normalTexture:h,emissiveTexture:v,emissiveFactor:g,alphaMode:o,alphaCutoff:s,doubleSided:c,extensions:{VRMC_materials_mtoon:fe}})}_parseV0UnlitProperties(e,t){let n=e.shader===`VRM/UnlitTransparentZWrite`,r=e.shader===`VRM/UnlitTransparent`||n,i=this._v0ParseRenderQueue(e),a=e.shader===`VRM/UnlitCutout`,o=r?`BLEND`:a?`MASK`:`OPAQUE`,s=a?e.floatProperties?._Cutoff??.5:void 0,c=this._portTextureTransform(e),l=(e.vectorProperties?._Color??[1,1,1,1]).map(Kp),u=e.textureProperties?._MainTex,d=u==null?void 0:{index:u,extensions:Up({},c)},f={specVersion:`1.0`,transparentWithZWrite:n,renderQueueOffsetNumber:i,shadeColorFactor:l,shadeMultiplyTexture:d};return Wp(Up({},t),{pbrMetallicRoughness:{baseColorFactor:l,baseColorTexture:d},alphaMode:o,alphaCutoff:s,extensions:{VRMC_materials_mtoon:f}})}_portTextureTransform(e){let t=e.vectorProperties?._MainTex;if(t==null)return{};let n=[t?.[0]??0,t?.[1]??0],r=[t?.[2]??1,t?.[3]??1];return n[1]=1-r[1]-n[1],{KHR_texture_transform:{offset:n,scale:r}}}_v0ParseRenderQueue(e){let t=e.shader===`VRM/UnlitTransparentZWrite`,n=e.keywordMap?._ALPHABLEND_ON!=null||e.shader===`VRM/UnlitTransparent`||t,r=e.floatProperties?._ZWrite===1||t,i=0;if(n){let t=e.renderQueue;t!=null&&(i=r?this._renderQueueMapTransparentZWrite.get(t):this._renderQueueMapTransparent.get(t))}return i}_populateRenderQueueMap(e){let t=new Set,n=new Set;e.forEach(e=>{let r=e.shader===`VRM/UnlitTransparentZWrite`,i=e.keywordMap?._ALPHABLEND_ON!=null||e.shader===`VRM/UnlitTransparent`||r,a=e.floatProperties?._ZWrite===1||r;if(i){let r=e.renderQueue;r!=null&&(a?n.add(r):t.add(r))}}),t.size>10&&console.warn(`VRMMaterialsV0CompatPlugin: This VRM uses ${t.size} render queues for Transparent materials while VRM 1.0 only supports up to 10 render queues. The model might not be rendered correctly.`),n.size>10&&console.warn(`VRMMaterialsV0CompatPlugin: This VRM uses ${n.size} render queues for TransparentZWrite materials while VRM 1.0 only supports up to 10 render queues. The model might not be rendered correctly.`),Array.from(t).sort().forEach((e,n)=>{let r=Math.min(Math.max(n-t.size+1,-9),0);this._renderQueueMapTransparent.set(e,r)}),Array.from(n).sort().forEach((e,t)=>{let n=Math.min(Math.max(t,0),9);this._renderQueueMapTransparentZWrite.set(e,n)})}},Jp=(e,t,n)=>new Promise((r,i)=>{var a=e=>{try{s(n.next(e))}catch(e){i(e)}},o=e=>{try{s(n.throw(e))}catch(e){i(e)}},s=e=>e.done?r(e.value):Promise.resolve(e.value).then(a,o);s((n=n.apply(e,t)).next())}),Yp=new U,Xp=class extends kn{constructor(e){super(),this._attrPosition=new gr(new Float32Array([0,0,0,0,0,0]),3),this._attrPosition.setUsage(Je);let t=new jr;t.setAttribute(`position`,this._attrPosition);let n=new Ri({color:16711935,depthTest:!1,depthWrite:!1});this._line=new Ki(t,n),this.add(this._line),this.constraint=e}updateMatrixWorld(e){Yp.setFromMatrixPosition(this.constraint.destination.matrixWorld),this._attrPosition.setXYZ(0,Yp.x,Yp.y,Yp.z),this.constraint.source&&Yp.setFromMatrixPosition(this.constraint.source.matrixWorld),this._attrPosition.setXYZ(1,Yp.x,Yp.y,Yp.z),this._attrPosition.needsUpdate=!0,super.updateMatrixWorld(e)}};function Zp(e,t){return t.set(e.elements[12],e.elements[13],e.elements[14])}var Qp=new U,$p=new U;function em(e,t){return e.decompose(Qp,t,$p),t}function tm(e){return e.invert?e.invert():e.inverse(),e}var nm=class{constructor(e,t){this.destination=e,this.source=t,this.weight=1}},rm=new U,im=new U,am=new U,om=new H,sm=new H,cm=new H,lm=class extends nm{get aimAxis(){return this._aimAxis}set aimAxis(e){this._aimAxis=e,this._v3AimAxis.set(e===`PositiveX`?1:e===`NegativeX`?-1:0,e===`PositiveY`?1:e===`NegativeY`?-1:0,e===`PositiveZ`?1:e===`NegativeZ`?-1:0)}get dependencies(){let e=new Set([this.source]);return this.destination.parent&&e.add(this.destination.parent),e}constructor(e,t){super(e,t),this._aimAxis=`PositiveX`,this._v3AimAxis=new U(1,0,0),this._dstRestQuat=new H}setInitState(){this._dstRestQuat.copy(this.destination.quaternion)}update(){this.destination.updateWorldMatrix(!0,!1),this.source.updateWorldMatrix(!0,!1);let e=om.identity(),t=sm.identity();this.destination.parent&&(em(this.destination.parent.matrixWorld,e),tm(t.copy(e)));let n=rm.copy(this._v3AimAxis).applyQuaternion(this._dstRestQuat).applyQuaternion(e),r=Zp(this.source.matrixWorld,im).sub(Zp(this.destination.matrixWorld,am)).normalize(),i=cm.setFromUnitVectors(n,r).premultiply(t).multiply(e).multiply(this._dstRestQuat);this.destination.quaternion.copy(this._dstRestQuat).slerp(i,this.weight)}};function um(e,t){let n=[e],r=e.parent;for(;r!==null;)n.unshift(r),r=r.parent;n.forEach(e=>{t(e)})}var dm=class{constructor(){this._constraints=new Set,this._objectConstraintsMap=new Map}get constraints(){return this._constraints}addConstraint(e){this._constraints.add(e);let t=this._objectConstraintsMap.get(e.destination);t??(t=new Set,this._objectConstraintsMap.set(e.destination,t)),t.add(e)}deleteConstraint(e){this._constraints.delete(e),this._objectConstraintsMap.get(e.destination).delete(e)}setInitState(){let e=new Set,t=new Set;for(let n of this._constraints)this._processConstraint(n,e,t,e=>e.setInitState())}update(){let e=new Set,t=new Set;for(let n of this._constraints)this._processConstraint(n,e,t,e=>e.update())}_processConstraint(e,t,n,r){if(n.has(e))return;if(t.has(e))throw Error(`VRMNodeConstraintManager: Circular dependency detected while updating constraints`);t.add(e);let i=e.dependencies;for(let e of i)um(e,e=>{let i=this._objectConstraintsMap.get(e);if(i)for(let e of i)this._processConstraint(e,t,n,r)});r(e),n.add(e)}},fm=new H,pm=new H,mm=class extends nm{get dependencies(){return new Set([this.source])}constructor(e,t){super(e,t),this._dstRestQuat=new H,this._invSrcRestQuat=new H}setInitState(){this._dstRestQuat.copy(this.destination.quaternion),tm(this._invSrcRestQuat.copy(this.source.quaternion))}update(){let e=fm.copy(this._invSrcRestQuat).multiply(this.source.quaternion),t=pm.copy(this._dstRestQuat).multiply(e);this.destination.quaternion.copy(this._dstRestQuat).slerp(t,this.weight)}},hm=new U,gm=new H,_m=new H,vm=class extends nm{get rollAxis(){return this._rollAxis}set rollAxis(e){this._rollAxis=e,this._v3RollAxis.set(+(e===`X`),+(e===`Y`),+(e===`Z`))}get dependencies(){return new Set([this.source])}constructor(e,t){super(e,t),this._rollAxis=`X`,this._v3RollAxis=new U(1,0,0),this._dstRestQuat=new H,this._invDstRestQuat=new H,this._invSrcRestQuatMulDstRestQuat=new H}setInitState(){this._dstRestQuat.copy(this.destination.quaternion),tm(this._invDstRestQuat.copy(this._dstRestQuat)),tm(this._invSrcRestQuatMulDstRestQuat.copy(this.source.quaternion)).multiply(this._dstRestQuat)}update(){let e=gm.copy(this._invDstRestQuat).multiply(this.source.quaternion).multiply(this._invSrcRestQuatMulDstRestQuat),t=hm.copy(this._v3RollAxis).applyQuaternion(e),n=_m.setFromUnitVectors(t,this._v3RollAxis).premultiply(this._dstRestQuat).multiply(e);this.destination.quaternion.copy(this._dstRestQuat).slerp(n,this.weight)}},ym=new Set([`1.0`,`1.0-beta`]),bm=class e{get name(){return e.EXTENSION_NAME}constructor(e,t){this.parser=e,this.helperRoot=t?.helperRoot}afterRoot(e){return Jp(this,null,function*(){e.userData.vrmNodeConstraintManager=yield this._import(e)})}_import(t){return Jp(this,null,function*(){let n=this.parser.json;if(n.extensionsUsed?.indexOf(e.EXTENSION_NAME)===-1)return null;let r=new dm,i=yield this.parser.getDependencies(`node`);return i.forEach((t,a)=>{let o=n.nodes[a]?.extensions?.[e.EXTENSION_NAME];if(o==null)return;let s=o.specVersion;if(!ym.has(s)){console.warn(`VRMNodeConstraintLoaderPlugin: Unknown ${e.EXTENSION_NAME} specVersion "${s}"`);return}let c=o.constraint;if(c.roll!=null){let e=this._importRollConstraint(t,i,c.roll);r.addConstraint(e)}else if(c.aim!=null){let e=this._importAimConstraint(t,i,c.aim);r.addConstraint(e)}else if(c.rotation!=null){let e=this._importRotationConstraint(t,i,c.rotation);r.addConstraint(e)}}),t.scene.updateMatrixWorld(),r.setInitState(),r})}_importRollConstraint(e,t,n){let{source:r,rollAxis:i,weight:a}=n,o=t[r],s=new vm(e,o);if(i!=null&&(s.rollAxis=i),a!=null&&(s.weight=a),this.helperRoot){let e=new Xp(s);this.helperRoot.add(e)}return s}_importAimConstraint(e,t,n){let{source:r,aimAxis:i,weight:a}=n,o=t[r],s=new lm(e,o);if(i!=null&&(s.aimAxis=i),a!=null&&(s.weight=a),this.helperRoot){let e=new Xp(s);this.helperRoot.add(e)}return s}_importRotationConstraint(e,t,n){let{source:r,weight:i}=n,a=t[r],o=new mm(e,a);if(i!=null&&(o.weight=i),this.helperRoot){let e=new Xp(o);this.helperRoot.add(e)}return o}};bm.EXTENSION_NAME=`VRMC_node_constraint`;var xm=bm,Sm=(e,t,n)=>new Promise((r,i)=>{var a=e=>{try{s(n.next(e))}catch(e){i(e)}},o=e=>{try{s(n.throw(e))}catch(e){i(e)}},s=e=>e.done?r(e.value):Promise.resolve(e.value).then(a,o);s((n=n.apply(e,t)).next())}),Cm=class{},wm=new U,Tm=new U,Em=class extends Cm{get type(){return`capsule`}constructor(e){super(),this.offset=e?.offset??new U(0,0,0),this.tail=e?.tail??new U(0,0,0),this.radius=e?.radius??0,this.inside=e?.inside??!1}calculateCollision(e,t,n,r){wm.setFromMatrixPosition(e),Tm.subVectors(this.tail,this.offset).applyMatrix4(e),Tm.sub(wm);let i=Tm.lengthSq();r.copy(t).sub(wm);let a=Tm.dot(r);a<=0||(i<=a||Tm.multiplyScalar(a/i),r.sub(Tm));let o=r.length(),s=this.inside?this.radius-n-o:o-n-this.radius;return s<0&&(r.multiplyScalar(1/o),this.inside&&r.negate()),s}},Dm=new U,Om=new W,km=class extends Cm{get type(){return`plane`}constructor(e){super(),this.offset=e?.offset??new U(0,0,0),this.normal=e?.normal??new U(0,0,1)}calculateCollision(e,t,n,r){r.setFromMatrixPosition(e),r.negate().add(t),Om.getNormalMatrix(e),Dm.copy(this.normal).applyNormalMatrix(Om).normalize();let i=r.dot(Dm)-n;return r.copy(Dm),i}},Am=new U,jm=class extends Cm{get type(){return`sphere`}constructor(e){super(),this.offset=e?.offset??new U(0,0,0),this.radius=e?.radius??0,this.inside=e?.inside??!1}calculateCollision(e,t,n,r){r.subVectors(t,Am.setFromMatrixPosition(e));let i=r.length(),a=this.inside?this.radius-n-i:i-n-this.radius;return a<0&&(r.multiplyScalar(1/i),this.inside&&r.negate()),a}},Mm=new U,Nm=class extends jr{constructor(e){super(),this.worldScale=1,this._currentRadius=0,this._currentOffset=new U,this._currentTail=new U,this._shape=e,this._attrPos=new gr(new Float32Array(396),3),this.setAttribute(`position`,this._attrPos),this._attrIndex=new gr(new Uint16Array(264),1),this.setIndex(this._attrIndex),this._buildIndex(),this.update()}update(){let e=!1,t=this._shape.radius/this.worldScale;this._currentRadius!==t&&(this._currentRadius=t,e=!0),this._currentOffset.equals(this._shape.offset)||(this._currentOffset.copy(this._shape.offset),e=!0);let n=Mm.copy(this._shape.tail).divideScalar(this.worldScale);this._currentTail.distanceToSquared(n)>1e-10&&(this._currentTail.copy(n),e=!0),e&&this._buildPosition()}_buildPosition(){Mm.copy(this._currentTail).sub(this._currentOffset);let e=Mm.length()/this._currentRadius;for(let t=0;t<=16;t++){let n=t/16*Math.PI;this._attrPos.setXYZ(t,-Math.sin(n),-Math.cos(n),0),this._attrPos.setXYZ(17+t,e+Math.sin(n),Math.cos(n),0),this._attrPos.setXYZ(34+t,-Math.sin(n),0,-Math.cos(n)),this._attrPos.setXYZ(51+t,e+Math.sin(n),0,Math.cos(n))}for(let t=0;t<32;t++){let n=t/16*Math.PI;this._attrPos.setXYZ(68+t,0,Math.sin(n),Math.cos(n)),this._attrPos.setXYZ(100+t,e,Math.sin(n),Math.cos(n))}let t=Math.atan2(Mm.y,Math.sqrt(Mm.x*Mm.x+Mm.z*Mm.z)),n=-Math.atan2(Mm.z,Mm.x);this.rotateZ(t),this.rotateY(n),this.scale(this._currentRadius,this._currentRadius,this._currentRadius),this.translate(this._currentOffset.x,this._currentOffset.y,this._currentOffset.z),this._attrPos.needsUpdate=!0}_buildIndex(){for(let e=0;e<34;e++){let t=(e+1)%34;this._attrIndex.setXY(e*2,e,t),this._attrIndex.setXY(68+e*2,34+e,34+t)}for(let e=0;e<32;e++){let t=(e+1)%32;this._attrIndex.setXY(136+e*2,68+e,68+t),this._attrIndex.setXY(200+e*2,100+e,100+t)}this._attrIndex.needsUpdate=!0}},Pm=class extends jr{constructor(e){super(),this.worldScale=1,this._currentOffset=new U,this._currentNormal=new U,this._shape=e,this._attrPos=new gr(new Float32Array(18),3),this.setAttribute(`position`,this._attrPos),this._attrIndex=new gr(new Uint16Array(10),1),this.setIndex(this._attrIndex),this._buildIndex(),this.update()}update(){let e=!1;this._currentOffset.equals(this._shape.offset)||(this._currentOffset.copy(this._shape.offset),e=!0),this._currentNormal.equals(this._shape.normal)||(this._currentNormal.copy(this._shape.normal),e=!0),e&&this._buildPosition()}_buildPosition(){this._attrPos.setXYZ(0,-.5,-.5,0),this._attrPos.setXYZ(1,.5,-.5,0),this._attrPos.setXYZ(2,.5,.5,0),this._attrPos.setXYZ(3,-.5,.5,0),this._attrPos.setXYZ(4,0,0,0),this._attrPos.setXYZ(5,0,0,.25),this.translate(this._currentOffset.x,this._currentOffset.y,this._currentOffset.z),this.lookAt(this._currentNormal),this._attrPos.needsUpdate=!0}_buildIndex(){this._attrIndex.setXY(0,0,1),this._attrIndex.setXY(2,1,2),this._attrIndex.setXY(4,2,3),this._attrIndex.setXY(6,3,0),this._attrIndex.setXY(8,4,5),this._attrIndex.needsUpdate=!0}},Fm=class extends jr{constructor(e){super(),this.worldScale=1,this._currentRadius=0,this._currentOffset=new U,this._shape=e,this._attrPos=new gr(new Float32Array(288),3),this.setAttribute(`position`,this._attrPos),this._attrIndex=new gr(new Uint16Array(192),1),this.setIndex(this._attrIndex),this._buildIndex(),this.update()}update(){let e=!1,t=this._shape.radius/this.worldScale;this._currentRadius!==t&&(this._currentRadius=t,e=!0),this._currentOffset.equals(this._shape.offset)||(this._currentOffset.copy(this._shape.offset),e=!0),e&&this._buildPosition()}_buildPosition(){for(let e=0;e<32;e++){let t=e/16*Math.PI;this._attrPos.setXYZ(e,Math.cos(t),Math.sin(t),0),this._attrPos.setXYZ(32+e,0,Math.cos(t),Math.sin(t)),this._attrPos.setXYZ(64+e,Math.sin(t),0,Math.cos(t))}this.scale(this._currentRadius,this._currentRadius,this._currentRadius),this.translate(this._currentOffset.x,this._currentOffset.y,this._currentOffset.z),this._attrPos.needsUpdate=!0}_buildIndex(){for(let e=0;e<32;e++){let t=(e+1)%32;this._attrIndex.setXY(e*2,e,t),this._attrIndex.setXY(64+e*2,32+e,32+t),this._attrIndex.setXY(128+e*2,64+e,64+t)}this._attrIndex.needsUpdate=!0}},Im=new U,Lm=class extends kn{constructor(e){if(super(),this.matrixAutoUpdate=!1,this.collider=e,this.collider.shape instanceof jm)this._geometry=new Fm(this.collider.shape);else if(this.collider.shape instanceof Em)this._geometry=new Nm(this.collider.shape);else if(this.collider.shape instanceof km)this._geometry=new Pm(this.collider.shape);else throw Error(`VRMSpringBoneColliderHelper: Unknown collider shape type detected`);let t=new Ri({color:16711935,depthTest:!1,depthWrite:!1});this._line=new Xi(this._geometry,t),this.add(this._line)}dispose(){this._geometry.dispose()}updateMatrixWorld(e){this.collider.updateWorldMatrix(!0,!1),this.matrix.copy(this.collider.matrixWorld);let t=this.matrix.elements;this._geometry.worldScale=Im.set(t[0],t[1],t[2]).length(),this._geometry.update(),super.updateMatrixWorld(e)}},Rm=class extends jr{constructor(e){super(),this.worldScale=1,this._currentRadius=0,this._currentTail=new U,this._springBone=e,this._attrPos=new gr(new Float32Array(294),3),this.setAttribute(`position`,this._attrPos),this._attrIndex=new gr(new Uint16Array(194),1),this.setIndex(this._attrIndex),this._buildIndex(),this.update()}update(){let e=!1,t=this._springBone.settings.hitRadius/this.worldScale;this._currentRadius!==t&&(this._currentRadius=t,e=!0),this._currentTail.equals(this._springBone.initialLocalChildPosition)||(this._currentTail.copy(this._springBone.initialLocalChildPosition),e=!0),e&&this._buildPosition()}_buildPosition(){for(let e=0;e<32;e++){let t=e/16*Math.PI;this._attrPos.setXYZ(e,Math.cos(t),Math.sin(t),0),this._attrPos.setXYZ(32+e,0,Math.cos(t),Math.sin(t)),this._attrPos.setXYZ(64+e,Math.sin(t),0,Math.cos(t))}this.scale(this._currentRadius,this._currentRadius,this._currentRadius),this.translate(this._currentTail.x,this._currentTail.y,this._currentTail.z),this._attrPos.setXYZ(96,0,0,0),this._attrPos.setXYZ(97,this._currentTail.x,this._currentTail.y,this._currentTail.z),this._attrPos.needsUpdate=!0}_buildIndex(){for(let e=0;e<32;e++){let t=(e+1)%32;this._attrIndex.setXY(e*2,e,t),this._attrIndex.setXY(64+e*2,32+e,32+t),this._attrIndex.setXY(128+e*2,64+e,64+t)}this._attrIndex.setXY(192,96,97),this._attrIndex.needsUpdate=!0}},zm=new U,Bm=class extends kn{constructor(e){super(),this.matrixAutoUpdate=!1,this.springBone=e,this._geometry=new Rm(this.springBone);let t=new Ri({color:16776960,depthTest:!1,depthWrite:!1});this._line=new Xi(this._geometry,t),this.add(this._line)}dispose(){this._geometry.dispose()}updateMatrixWorld(e){this.springBone.bone.updateWorldMatrix(!0,!1),this.matrix.copy(this.springBone.bone.matrixWorld);let t=this.matrix.elements;this._geometry.worldScale=zm.set(t[0],t[1],t[2]).length(),this._geometry.update(),super.updateMatrixWorld(e)}},Vm=class extends On{constructor(e){super(),this.colliderMatrix=new K,this.shape=e}updateWorldMatrix(e,t){super.updateWorldMatrix(e,t),Hm(this.colliderMatrix,this.matrixWorld,this.shape.offset)}};function Hm(e,t,n){let r=t.elements;e.copy(t),n&&(e.elements[12]=r[0]*n.x+r[4]*n.y+r[8]*n.z+r[12],e.elements[13]=r[1]*n.x+r[5]*n.y+r[9]*n.z+r[13],e.elements[14]=r[2]*n.x+r[6]*n.y+r[10]*n.z+r[14])}var Um=new K;function Wm(e){return e.invert?e.invert():e.getInverse(Um.copy(e)),e}var Gm=class{constructor(e){this._inverseCache=new K,this._shouldUpdateInverse=!0,this.matrix=e;let t={set:(e,t,n)=>(this._shouldUpdateInverse=!0,e[t]=n,!0)};this._originalElements=e.elements,e.elements=new Proxy(e.elements,t)}get inverse(){return this._shouldUpdateInverse&&=(Wm(this._inverseCache.copy(this.matrix)),!1),this._inverseCache}revert(){this.matrix.elements=this._originalElements}},Km=new K,qm=new U,Jm=new U,Ym=new U,Xm=new U,Zm=new K,Qm=class{constructor(e,t,n={},r=[]){this._currentTail=new U,this._prevTail=new U,this._boneAxis=new U,this._worldSpaceBoneLength=0,this._center=null,this._initialLocalMatrix=new K,this._initialLocalRotation=new H,this._initialLocalChildPosition=new U,this.bone=e,this.bone.matrixAutoUpdate=!1,this.child=t,this.settings={hitRadius:n.hitRadius??0,stiffness:n.stiffness??1,gravityPower:n.gravityPower??0,gravityDir:n.gravityDir?.clone()??new U(0,-1,0),dragForce:n.dragForce??.4},this.colliderGroups=r}get dependencies(){let e=new Set,t=this.bone.parent;t&&e.add(t);for(let t=0;t<this.colliderGroups.length;t++)for(let n=0;n<this.colliderGroups[t].colliders.length;n++)e.add(this.colliderGroups[t].colliders[n]);return e}get center(){return this._center}set center(e){this._center?.userData.inverseCacheProxy&&(this._center.userData.inverseCacheProxy.revert(),delete this._center.userData.inverseCacheProxy),this._center=e,this._center&&(this._center.userData.inverseCacheProxy||(this._center.userData.inverseCacheProxy=new Gm(this._center.matrixWorld)))}get initialLocalChildPosition(){return this._initialLocalChildPosition}get _parentMatrixWorld(){return this.bone.parent?this.bone.parent.matrixWorld:Km}setInitState(){this._initialLocalMatrix.copy(this.bone.matrix),this._initialLocalRotation.copy(this.bone.quaternion),this.child?this._initialLocalChildPosition.copy(this.child.position):this._initialLocalChildPosition.copy(this.bone.position).normalize().multiplyScalar(.07);let e=this._getMatrixWorldToCenter();this.bone.localToWorld(this._currentTail.copy(this._initialLocalChildPosition)).applyMatrix4(e),this._prevTail.copy(this._currentTail),this._boneAxis.copy(this._initialLocalChildPosition).normalize()}reset(){this.bone.quaternion.copy(this._initialLocalRotation),this.bone.updateMatrix(),this.bone.matrixWorld.multiplyMatrices(this._parentMatrixWorld,this.bone.matrix);let e=this._getMatrixWorldToCenter();this.bone.localToWorld(this._currentTail.copy(this._initialLocalChildPosition)).applyMatrix4(e),this._prevTail.copy(this._currentTail)}update(e){if(e<=0)return;this._calcWorldSpaceBoneLength();let t=Jm.copy(this._boneAxis).transformDirection(this._initialLocalMatrix).transformDirection(this._parentMatrixWorld);Xm.copy(this._currentTail).add(qm.subVectors(this._currentTail,this._prevTail).multiplyScalar(1-this.settings.dragForce)).applyMatrix4(this._getMatrixCenterToWorld()).addScaledVector(t,this.settings.stiffness*e).addScaledVector(this.settings.gravityDir,this.settings.gravityPower*e),Ym.setFromMatrixPosition(this.bone.matrixWorld),Xm.sub(Ym).normalize().multiplyScalar(this._worldSpaceBoneLength).add(Ym),this._collision(Xm),this._prevTail.copy(this._currentTail),this._currentTail.copy(Xm).applyMatrix4(this._getMatrixWorldToCenter());let n=Zm.multiplyMatrices(this._parentMatrixWorld,this._initialLocalMatrix).invert();this.bone.quaternion.setFromUnitVectors(this._boneAxis,qm.copy(Xm).applyMatrix4(n).normalize()).premultiply(this._initialLocalRotation),this.bone.updateMatrix(),this.bone.matrixWorld.multiplyMatrices(this._parentMatrixWorld,this.bone.matrix)}_collision(e){for(let t=0;t<this.colliderGroups.length;t++)for(let n=0;n<this.colliderGroups[t].colliders.length;n++){let r=this.colliderGroups[t].colliders[n],i=r.shape.calculateCollision(r.colliderMatrix,e,this.settings.hitRadius,qm);if(i<0){e.addScaledVector(qm,-i),e.sub(Ym);let t=e.length();e.multiplyScalar(this._worldSpaceBoneLength/t).add(Ym)}}}_calcWorldSpaceBoneLength(){qm.setFromMatrixPosition(this.bone.matrixWorld),this.child?Jm.setFromMatrixPosition(this.child.matrixWorld):(Jm.copy(this._initialLocalChildPosition),Jm.applyMatrix4(this.bone.matrixWorld)),this._worldSpaceBoneLength=qm.sub(Jm).length()}_getMatrixCenterToWorld(){return this._center?this._center.matrixWorld:Km}_getMatrixWorldToCenter(){return this._center?this._center.userData.inverseCacheProxy.inverse:Km}};function $m(e,t){let n=[],r=e;for(;r!==null;)n.unshift(r),r=r.parent;n.forEach(e=>{t(e)})}function eh(e,t){e.children.forEach(e=>{t(e)||eh(e,t)})}function th(e){let t=new Map;for(let n of e){let r=n;do{let n=(t.get(r)??0)+1;if(n===e.size)return r;t.set(r,n),r=r.parent}while(r!==null)}return null}var nh=class{constructor(){this._joints=new Set,this._sortedJoints=[],this._hasWarnedCircularDependency=!1,this._ancestors=[],this._objectSpringBonesMap=new Map,this._isSortedJointsDirty=!1,this._relevantChildrenUpdated=this._relevantChildrenUpdated.bind(this)}get joints(){return this._joints}get springBones(){return console.warn(`VRMSpringBoneManager: springBones is deprecated. use joints instead.`),this._joints}get colliderGroups(){let e=new Set;return this._joints.forEach(t=>{t.colliderGroups.forEach(t=>{e.add(t)})}),Array.from(e)}get colliders(){let e=new Set;return this.colliderGroups.forEach(t=>{t.colliders.forEach(t=>{e.add(t)})}),Array.from(e)}addJoint(e){this._joints.add(e);let t=this._objectSpringBonesMap.get(e.bone);t??(t=new Set,this._objectSpringBonesMap.set(e.bone,t)),t.add(e),this._isSortedJointsDirty=!0}addSpringBone(e){console.warn(`VRMSpringBoneManager: addSpringBone() is deprecated. use addJoint() instead.`),this.addJoint(e)}deleteJoint(e){this._joints.delete(e),this._objectSpringBonesMap.get(e.bone).delete(e),this._isSortedJointsDirty=!0}deleteSpringBone(e){console.warn(`VRMSpringBoneManager: deleteSpringBone() is deprecated. use deleteJoint() instead.`),this.deleteJoint(e)}setInitState(){this._sortJoints();for(let e=0;e<this._sortedJoints.length;e++){let t=this._sortedJoints[e];t.bone.updateMatrix(),t.bone.updateWorldMatrix(!1,!1),t.setInitState()}}reset(){this._sortJoints();for(let e=0;e<this._sortedJoints.length;e++){let t=this._sortedJoints[e];t.bone.updateMatrix(),t.bone.updateWorldMatrix(!1,!1),t.reset()}}update(e){this._sortJoints();for(let e=0;e<this._ancestors.length;e++)this._ancestors[e].updateWorldMatrix(e===0,!1);for(let t=0;t<this._sortedJoints.length;t++){let n=this._sortedJoints[t];n.bone.updateMatrix(),n.bone.updateWorldMatrix(!1,!1),n.update(e),eh(n.bone,this._relevantChildrenUpdated)}}_sortJoints(){if(!this._isSortedJointsDirty)return;let e=[],t=new Set,n=new Set,r=new Set;for(let i of this._joints)this._insertJointSort(i,t,n,e,r);this._sortedJoints=e;let i=th(r);this._ancestors=[],i&&(this._ancestors.push(i),eh(i,e=>(this._objectSpringBonesMap.get(e)?.size??0)>0?!0:(this._ancestors.push(e),!1))),this._isSortedJointsDirty=!1}_insertJointSort(e,t,n,r,i){if(n.has(e))return;if(t.has(e)){this._hasWarnedCircularDependency||=(console.warn(`VRMSpringBoneManager: Circular dependency detected`),!0);return}t.add(e);let a=e.dependencies;for(let e of a){let a=!1,o=null;$m(e,e=>{let s=this._objectSpringBonesMap.get(e);if(s)for(let e of s)a=!0,this._insertJointSort(e,t,n,r,i);else a||(o=e)}),o&&i.add(o)}r.push(e),n.add(e)}_relevantChildrenUpdated(e){return(this._objectSpringBonesMap.get(e)?.size??0)>0?!0:(e.updateWorldMatrix(!1,!1),!1)}},rh=`VRMC_springBone_extended_collider`,ih=new Set([`1.0`,`1.0-beta`]),ah=new Set([`1.0`]),oh=class e{get name(){return e.EXTENSION_NAME}constructor(e,t){this.parser=e,this.jointHelperRoot=t?.jointHelperRoot,this.colliderHelperRoot=t?.colliderHelperRoot,this.useExtendedColliders=t?.useExtendedColliders??!0}afterRoot(e){return Sm(this,null,function*(){e.userData.vrmSpringBoneManager=yield this._import(e)})}_import(e){return Sm(this,null,function*(){return(yield this._v1Import(e))??(yield this._v0Import(e))??null})}_v1Import(t){return Sm(this,null,function*(){var n;let r=t.parser.json;if(r.extensionsUsed?.indexOf(e.EXTENSION_NAME)===-1)return null;let i=new nh,a=yield t.parser.getDependencies(`node`),o=r.extensions?.[e.EXTENSION_NAME];if(!o)return null;let s=o.specVersion;if(!ih.has(s))return console.warn(`VRMSpringBoneLoaderPlugin: Unknown ${e.EXTENSION_NAME} specVersion "${s}"`),null;let c=o.colliders?.map((t,n)=>{let r=a[t.node];if(r==null)return console.warn(`VRMSpringBoneLoaderPlugin: The collider #${n} attempted to use the node #${t.node} but not found`),null;let i=t.shape,o=t.extensions?.[rh];if(this.useExtendedColliders&&o!=null){let t=o.specVersion;if(!ah.has(t))console.warn(`VRMSpringBoneLoaderPlugin: Unknown ${rh} specVersion "${t}". Fallbacking to the ${e.EXTENSION_NAME} definition`);else{let e=o.shape;if(e.sphere)return this._importSphereCollider(r,{offset:new U().fromArray(e.sphere.offset??[0,0,0]),radius:e.sphere.radius??0,inside:e.sphere.inside??!1});if(e.capsule)return this._importCapsuleCollider(r,{offset:new U().fromArray(e.capsule.offset??[0,0,0]),radius:e.capsule.radius??0,tail:new U().fromArray(e.capsule.tail??[0,0,0]),inside:e.capsule.inside??!1});if(e.plane)return this._importPlaneCollider(r,{offset:new U().fromArray(e.plane.offset??[0,0,0]),normal:new U().fromArray(e.plane.normal??[0,0,1])})}}if(i.sphere)return this._importSphereCollider(r,{offset:new U().fromArray(i.sphere.offset??[0,0,0]),radius:i.sphere.radius??0,inside:!1});if(i.capsule)return this._importCapsuleCollider(r,{offset:new U().fromArray(i.capsule.offset??[0,0,0]),radius:i.capsule.radius??0,tail:new U().fromArray(i.capsule.tail??[0,0,0]),inside:!1});throw Error(`VRMSpringBoneLoaderPlugin: The collider #${n} has no valid shape`)}),l=o.colliderGroups?.map((e,t)=>({colliders:(e.colliders??[]).flatMap(e=>c?.[e]??(console.warn(`VRMSpringBoneLoaderPlugin: The colliderGroup #${t} attempted to use a collider #${e} but not found`),[])),name:e.name}));return(n=o.springs)==null||n.forEach((e,t)=>{let n=e.joints,r=e.colliderGroups?.map(e=>{let n=l?.[e];if(n==null)throw Error(`VRMSpringBoneLoaderPlugin: The spring #${t} attempted to use a colliderGroup ${e} but not found`);return n}),o=e.center==null?void 0:a[e.center],s;n.forEach(e=>{if(s){let t=a[s.node],n=a[e.node],c={hitRadius:s.hitRadius,dragForce:s.dragForce,gravityPower:s.gravityPower,stiffness:s.stiffness,gravityDir:s.gravityDir==null?void 0:new U().fromArray(s.gravityDir)},l=this._importJoint(t,n,c,r);o&&(l.center=o),i.addJoint(l)}s=e})}),i.setInitState(),i})}_v0Import(e){return Sm(this,null,function*(){let t=e.parser.json;if(t.extensionsUsed?.indexOf(`VRM`)===-1)return null;let n=t.extensions?.VRM?.secondaryAnimation;if(!n)return null;let r=n?.boneGroups;if(!r)return null;let i=new nh,a=yield e.parser.getDependencies(`node`),o=n.colliderGroups?.map(e=>{let t=a[e.node];return{colliders:(e.colliders??[]).map((e,n)=>{let r=new U(0,0,0);return e.offset&&r.set(e.offset.x??0,e.offset.y??0,e.offset.z?-e.offset.z:0),this._importSphereCollider(t,{offset:r,radius:e.radius??0,inside:!1})})}});return r?.forEach((e,t)=>{let n=e.bones;n&&n.forEach(n=>{let r=a[n],s=new U;e.gravityDir?s.set(e.gravityDir.x??0,e.gravityDir.y??0,e.gravityDir.z??0):s.set(0,-1,0);let c=e.center==null?void 0:a[e.center],l={hitRadius:e.hitRadius,dragForce:e.dragForce,gravityPower:e.gravityPower,stiffness:e.stiffiness,gravityDir:s},u=e.colliderGroups?.map(e=>{let n=o?.[e];if(n==null)throw Error(`VRMSpringBoneLoaderPlugin: The spring #${t} attempted to use a colliderGroup ${e} but not found`);return n});r.traverse(e=>{let t=e.children[0]??null,n=this._importJoint(e,t,l,u);c&&(n.center=c),i.addJoint(n)})})}),e.scene.updateMatrixWorld(),i.setInitState(),i})}_importJoint(e,t,n,r){let i=new Qm(e,t,n,r);if(this.jointHelperRoot){let e=new Bm(i);this.jointHelperRoot.add(e),e.renderOrder=this.jointHelperRoot.renderOrder}return i}_importSphereCollider(e,t){let n=new Vm(new jm(t));if(e.add(n),this.colliderHelperRoot){let e=new Lm(n);this.colliderHelperRoot.add(e),e.renderOrder=this.colliderHelperRoot.renderOrder}return n}_importCapsuleCollider(e,t){let n=new Vm(new Em(t));if(e.add(n),this.colliderHelperRoot){let e=new Lm(n);this.colliderHelperRoot.add(e),e.renderOrder=this.colliderHelperRoot.renderOrder}return n}_importPlaneCollider(e,t){let n=new Vm(new km(t));if(e.add(n),this.colliderHelperRoot){let e=new Lm(n);this.colliderHelperRoot.add(e),e.renderOrder=this.colliderHelperRoot.renderOrder}return n}};oh.EXTENSION_NAME=`VRMC_springBone`;var sh=oh,ch=class{get name(){return`VRMLoaderPlugin`}constructor(e,t){this.parser=e;let n=t?.helperRoot,r=t?.autoUpdateHumanBones;this.expressionPlugin=t?.expressionPlugin??new rf(e),this.firstPersonPlugin=t?.firstPersonPlugin??new cf(e),this.humanoidPlugin=t?.humanoidPlugin??new Df(e,{helperRoot:n,autoUpdateHumanBones:r}),this.lookAtPlugin=t?.lookAtPlugin??new lp(e,{helperRoot:n}),this.metaPlugin=t?.metaPlugin??new fp(e),this.mtoonMaterialPlugin=t?.mtoonMaterialPlugin??new Mp(e),this.materialsHDREmissiveMultiplierPlugin=t?.materialsHDREmissiveMultiplierPlugin??new Fp(e),this.materialsV0CompatPlugin=t?.materialsV0CompatPlugin??new qp(e),this.springBonePlugin=t?.springBonePlugin??new sh(e,{colliderHelperRoot:n,jointHelperRoot:n}),this.nodeConstraintPlugin=t?.nodeConstraintPlugin??new xm(e,{helperRoot:n})}beforeRoot(){return Ld(this,null,function*(){yield this.materialsV0CompatPlugin.beforeRoot(),yield this.mtoonMaterialPlugin.beforeRoot()})}loadMesh(e){return Ld(this,null,function*(){return yield this.mtoonMaterialPlugin.loadMesh(e)})}getMaterialType(e){return this.mtoonMaterialPlugin.getMaterialType(e)??null}extendMaterialParams(e,t){return Ld(this,null,function*(){yield this.materialsHDREmissiveMultiplierPlugin.extendMaterialParams(e,t),yield this.mtoonMaterialPlugin.extendMaterialParams(e,t)})}afterRoot(e){return Ld(this,null,function*(){yield this.metaPlugin.afterRoot(e),yield this.humanoidPlugin.afterRoot(e),yield this.expressionPlugin.afterRoot(e),yield this.lookAtPlugin.afterRoot(e),yield this.firstPersonPlugin.afterRoot(e),yield this.springBonePlugin.afterRoot(e),yield this.nodeConstraintPlugin.afterRoot(e),yield this.mtoonMaterialPlugin.afterRoot(e);let t=e.userData.vrmMeta,n=e.userData.vrmHumanoid;if(t&&n){let r=new mp({scene:e.scene,expressionManager:e.userData.vrmExpressionManager,firstPerson:e.userData.vrmFirstPerson,humanoid:n,lookAt:e.userData.vrmLookAt,meta:t,materials:e.userData.vrmMToonMaterials,springBoneManager:e.userData.vrmSpringBoneManager,nodeConstraintManager:e.userData.vrmNodeConstraintManager});e.userData.vrm=r}})}};function lh(e){let t=new Set;return e.traverse(e=>{if(!e.isMesh)return;let n=e;t.add(n)}),t}function uh(e,t,n){if(t.size===1){let n=t.values().next().value;if(n.weight===1)return e[n.index]}let r=new Float32Array(e[0].count*3),i=0;if(n)i=1;else for(let e of t)i+=e.weight;for(let n of t){let t=e[n.index],a=n.weight/i;for(let e=0;e<t.count;e++)r[e*3+0]+=t.getX(e)*a,r[e*3+1]+=t.getY(e)*a,r[e*3+2]+=t.getZ(e)*a}return new gr(r,3)}function dh(e){let t=lh(e.scene),n=new Map,r=e.expressionManager?.expressionMap;if(r!=null)for(let[e,t]of Object.entries(r)){let r=new Set;for(let i of t.binds)if(i instanceof Zd){if(i.weight!==0)for(let t of i.primitives){let r=n.get(t);r??(r=new Map,n.set(t,r));let a=r.get(e);a??(a=new Set,r.set(e,a)),a.add(i)}r.add(i)}for(let e of r)t.deleteBind(e)}for(let e of t){let t=n.get(e);if(t==null)continue;let i=e.geometry.morphAttributes;e.geometry.morphAttributes={};let a=e.geometry.clone();e.geometry=a;let o=a.morphTargetsRelative,s=i.position!=null,c=i.normal!=null,l={},u={},d=[];if(s||c){s&&(l.position=[]),c&&(l.normal=[]);let n=0;for(let[a,f]of t)s&&(l.position[n]=uh(i.position,f,o)),c&&(l.normal[n]=uh(i.normal,f,o)),r?.[a].addBind(new Zd({index:n,weight:1,primitives:[e]})),u[a]=n,d.push(0),n++}a.morphAttributes=l,e.morphTargetDictionary=u,e.morphTargetInfluences=d}}function fh(e,t,n){if(e.getComponent)return e.getComponent(t,n);{let r=e.array[t*e.itemSize+n];return e.normalized&&(r=Nt.denormalize(r,e.array)),r}}function ph(e,t,n,r){e.setComponent?e.setComponent(t,n,r):(e.normalized&&(r=Nt.normalize(r,e.array)),e.array[t*e.itemSize+n]=r)}function mh(e){let t=hh(e),n=new Set;for(let e of t)n.has(e.geometry)&&(e.geometry=Sh(e.geometry)),n.add(e.geometry);let r=new Map;for(let e of n){let t=e.getAttribute(`skinIndex`),n=r.get(t)??new Map;r.set(t,n);let i=e.getAttribute(`skinWeight`),a=gh(t,i);n.set(i,a)}let i=new Map;for(let e of t){let t=_h(e,r);i.set(e,t)}let a=[];for(let[e,t]of i){let n=!1;for(let r of a)if(vh(t,r.boneInverseMap)){n=!0,r.meshes.add(e);for(let[e,n]of t)r.boneInverseMap.set(e,n);break}n||a.push({boneInverseMap:t,meshes:new Set([e])})}let o=new Map,s=new xh,c=new xh,l=new xh;for(let e of a){let{boneInverseMap:t,meshes:n}=e,r=Array.from(t.keys()),i=new bi(r,Array.from(t.values())),a=c.getOrCreate(i);for(let e of n){let t=e.geometry.getAttribute(`skinIndex`),n=s.getOrCreate(t),i=e.skeleton.bones,c=`${n};${a};${i.map(e=>l.getOrCreate(e)).join(`,`)}`,u=o.get(c);u??(u=t.clone(),yh(u,i,r),o.set(c,u)),e.geometry.setAttribute(`skinIndex`,u)}for(let e of n)e.bind(i,new K)}}function hh(e){let t=new Set;return e.traverse(e=>{if(!e.isSkinnedMesh)return;let n=e;t.add(n)}),t}function gh(e,t){let n=new Set;for(let r=0;r<e.count;r++)for(let i=0;i<e.itemSize;i++){let a=fh(e,r,i);fh(t,r,i)!==0&&n.add(a)}return n}function _h(e,t){let n=new Map,r=e.skeleton,i=e.geometry,a=i.getAttribute(`skinIndex`),o=i.getAttribute(`skinWeight`),s=t.get(a)?.get(o);if(!s)throw Error(`Unreachable. attributeUsedIndexSetMap does not know the skin index attribute or the skin weight attribute.`);for(let e of s)n.set(r.bones[e],r.boneInverses[e]);return n}function vh(e,t){for(let[n,r]of e.entries()){let e=t.get(n);if(e!=null&&!bh(r,e))return!1}return!0}function yh(e,t,n){let r=new Map;for(let e of t)r.set(e,r.size);let i=new Map;for(let[e,t]of n.entries()){let n=r.get(t);i.set(n,e)}for(let t=0;t<e.count;t++)for(let n=0;n<e.itemSize;n++){let r=fh(e,t,n),a=i.get(r);ph(e,t,n,a)}e.needsUpdate=!0}function bh(e,t,n){if(n||=1e-4,e.elements.length!=t.elements.length)return!1;for(let r=0,i=e.elements.length;r<i;r++)if(Math.abs(e.elements[r]-t.elements[r])>n)return!1;return!0}var xh=class{constructor(){this._objectIndexMap=new Map,this._index=0}get(e){return this._objectIndexMap.get(e)}getOrCreate(e){let t=this._objectIndexMap.get(e);return t??(t=this._index,this._objectIndexMap.set(e,t),this._index++),t}};function Sh(e){let t=new jr;t.name=e.name,t.setIndex(e.index);for(let[n,r]of Object.entries(e.attributes))t.setAttribute(n,r);for(let[n,r]of Object.entries(e.morphAttributes)){let e=n;t.morphAttributes[e]=r.concat()}t.morphTargetsRelative=e.morphTargetsRelative,t.groups=[];for(let n of e.groups)t.addGroup(n.start,n.count,n.materialIndex);return t.boundingSphere=e.boundingSphere?.clone()??null,t.boundingBox=e.boundingBox?.clone()??null,t.drawRange.start=e.drawRange.start,t.drawRange.count=e.drawRange.count,t.userData=e.userData,t}function Ch(e){if(Object.values(e).forEach(e=>{e?.isTexture&&e.dispose()}),e.isShaderMaterial){let t=e.uniforms;t&&Object.values(t).forEach(e=>{let t=e.value;t?.isTexture&&t.dispose()})}e.dispose()}function wh(e){let t=e.geometry;t&&t.dispose();let n=e.skeleton;n&&n.dispose();let r=e.material;r&&(Array.isArray(r)?r.forEach(e=>Ch(e)):r&&Ch(r))}function Th(e){e.traverse(wh)}function Eh(e,t){console.warn(`VRMUtils.removeUnnecessaryJoints: removeUnnecessaryJoints is deprecated. Use combineSkeletons instead. combineSkeletons contributes more to the performance improvement. This function will be removed in the next major version.`);let n=t?.experimentalSameBoneCounts??!1,r=[];e.traverse(e=>{e.type===`SkinnedMesh`&&r.push(e)});let i=new Map,a=0;for(let e of r){let t=e.geometry.getAttribute(`skinIndex`);if(i.has(t))continue;let n=new Map,r=new Map;for(let e=0;e<t.count;e++)for(let i=0;i<t.itemSize;i++){let a=fh(t,e,i),o=n.get(a);o??(o=n.size,n.set(a,o),r.set(o,a)),ph(t,e,i,o)}t.needsUpdate=!0,i.set(t,r),a=Math.max(a,n.size)}for(let e of r){let t=e.geometry.getAttribute(`skinIndex`),r=i.get(t),o=[],s=[],c=n?a:r.size;for(let t=0;t<c;t++){let n=r.get(t)??0;o.push(e.skeleton.bones[n]),s.push(e.skeleton.boneInverses[n])}let l=new bi(o,s);e.bind(l,new K)}}function Dh(e,t){let n=e.position.count,r=Array(n),i=0,a=t.array;for(let e=0;e<a.length;e++){let t=a[e];r[t]||(r[t]=!0,i++)}return{isVertexUsed:r,vertexCount:n,verticesUsed:i}}function Oh(e){let t=[],n=[],r=0;for(let i=0;i<e.length;i++)if(e[i]){let e=r++;t[i]=e,n[e]=i}return{originalIndexNewIndexMap:t,newIndexOriginalIndexMap:n}}function kh(e,t){t.name=e.name,t.morphTargetsRelative=e.morphTargetsRelative,e.groups.forEach(e=>{t.addGroup(e.start,e.count,e.materialIndex)}),t.boundingBox=e.boundingBox?.clone()??null,t.boundingSphere=e.boundingSphere?.clone()??null,t.setDrawRange(e.drawRange.start,e.drawRange.count),t.userData=e.userData}function Ah(e,t,n){let r=t.array,i=new r.constructor(r.length);for(let e=0;e<r.length;e++)i[e]=n[r[e]];e.setIndex(new gr(i,t.itemSize,t.normalized))}function jh(e,t,n){let r=e.constructor,i=new r(t.length*n),a=!0;for(let r=0;r<t.length;r++){let o=t[r]*n,s=r*n;for(let t=0;t<n;t++){let n=e[o+t];i[s+t]=n,a&&=n===0}}return[i,a]}function Mh(e){let t=new Map,n=[];for(let[r,i]of Object.entries(e))if(i.isInterleavedBufferAttribute){let e=i,n=e.data,a=t.get(n)??[];t.set(n,a),a.push([r,e])}else{let e=i;n.push([r,e])}return[t,n]}function Nh(e,t,n){let[r,i]=Mh(t);for(let[t,i]of r){let r=t.array,{stride:a}=t,[o,s]=jh(r,n,a),c=new Mr(o,a);c.setUsage(t.usage);for(let[t,n]of i){let{itemSize:r,offset:i,normalized:a}=n,o=new Pr(c,r,i,a);e.setAttribute(t,o)}}for(let[t,r]of i){let i=r.array,{itemSize:a,normalized:o}=r,[s,c]=jh(i,n,a);e.setAttribute(t,new gr(s,a,o))}}function Ph(e){let t=new Map,n=[];for(let[r,i]of Object.entries(e)){let e=r;for(let r=0;r<i.length;r++){let a=i[r];if(a.isInterleavedBufferAttribute){let n=a,i=n.data,o=t.get(i)??[];t.set(i,o),o.push([e,r,n])}else{let t=a;n.push([e,r,t])}}}return[t,n]}function Fh(e,t,n){let r=!0,[i,a]=Ph(t),o={};for(let[e,t]of i){let i=e.array,{stride:a}=e,[s,c]=jh(i,n,a);r&&=c;let l=new Mr(s,a);l.setUsage(e.usage);for(let[e,n,r]of t){let{itemSize:t,offset:i,normalized:a}=r,s=new Pr(l,t,i,a);o[e]??(o[e]=[]),o[e][n]=s}}for(let[e,t,i]of a){let a=i,s=a.array,{itemSize:c,normalized:l}=a,[u,d]=jh(s,n,c);r&&=d,o[e]??(o[e]=[]),o[e][t]=new gr(u,c,l)}e.morphAttributes=r?{}:o}function Ih(e){let t=new Map;e.traverse(e=>{if(!e.isMesh)return;let n=e,r=n.geometry,i=r.index;if(i==null)return;let a=t.get(r);if(a!=null){n.geometry=a;return}let{isVertexUsed:o,vertexCount:s,verticesUsed:c}=Dh(r.attributes,i);if(c===s)return;let{originalIndexNewIndexMap:l,newIndexOriginalIndexMap:u}=Oh(o),d=new jr;kh(r,d),t.set(r,d),Ah(d,i,l),Nh(d,r.attributes,u),Fh(d,r.morphAttributes,u),n.geometry=d}),Array.from(t.keys()).forEach(e=>{e.dispose()})}function Lh(e){e.meta?.metaVersion===`0`&&(e.scene.rotation.y=Math.PI)}var Rh=class{constructor(){}};Rh.combineMorphs=dh,Rh.combineSkeletons=mh,Rh.deepDispose=Th,Rh.removeUnnecessaryJoints=Eh,Rh.removeUnnecessaryVertices=Ih,Rh.rotateVRM0=Lh;var zh=`/sign-vrm/`,Bh=new URLSearchParams(window.location.search),Vh=Bh.get(`embed`)===`1`,Hh=Wh(Bh.get(`keypoints`)||`keypoints/sample_0200_keypoints_smooth.jsonl`),Uh=`${zh}models/avatar.vrm`;document.body.classList.toggle(`embed`,Vh);function Wh(e){return/^https?:\/\//.test(e)||e.startsWith(`/`)?e:`${zh}${e}`}var Gh=[[11,13,15],[12,14,16],[11,12],[11,23],[12,24],[23,24]],Kh=[[0,1],[1,2],[2,3],[3,4],[0,5],[5,6],[6,7],[7,8],[5,9],[9,10],[10,11],[11,12],[9,13],[13,14],[14,15],[15,16],[13,17],[17,18],[18,19],[19,20],[0,17]],qh={Left:{thumb:[Z.LeftThumbMetacarpal,Z.LeftThumbProximal,Z.LeftThumbDistal],index:[Z.LeftIndexProximal,Z.LeftIndexIntermediate,Z.LeftIndexDistal],middle:[Z.LeftMiddleProximal,Z.LeftMiddleIntermediate,Z.LeftMiddleDistal],ring:[Z.LeftRingProximal,Z.LeftRingIntermediate,Z.LeftRingDistal],little:[Z.LeftLittleProximal,Z.LeftLittleIntermediate,Z.LeftLittleDistal]},Right:{thumb:[Z.RightThumbMetacarpal,Z.RightThumbProximal,Z.RightThumbDistal],index:[Z.RightIndexProximal,Z.RightIndexIntermediate,Z.RightIndexDistal],middle:[Z.RightMiddleProximal,Z.RightMiddleIntermediate,Z.RightMiddleDistal],ring:[Z.RightRingProximal,Z.RightRingIntermediate,Z.RightRingDistal],little:[Z.RightLittleProximal,Z.RightLittleIntermediate,Z.RightLittleDistal]}},Jh={thumb:[1,2,3,4],index:[5,6,7,8],middle:[9,10,11,12],ring:[13,14,15,16],little:[17,18,19,20]},Yh={thumb:{curl:.72,spread:.42,weights:[.62,.48,.34]},index:{curl:.95,spread:.28,weights:[.78,.64,.42]},middle:{curl:1,spread:.18,weights:[.82,.68,.44]},ring:{curl:.92,spread:.24,weights:[.76,.62,.4]},little:{curl:.84,spread:.34,weights:[.7,.56,.36]}},Xh=.34,Zh=1.45,Qh=.3,$h=.22,eg=1.28,tg=1.14,ng=.36,rg=118,ig=78,ag=.18,og=.22,sg=.12,cg=.08,lg=.28,ug=4.8,dg=7.5,fg=8.5,pg=11,mg=26,hg=16,gg=.68,_g=.68,vg=.045,yg=.018,bg=new Set([Z.Spine,Z.Chest]),xg=new Set(Object.values(qh).flatMap(e=>Object.values(e).flat())),Sg=new H,Cg=new dn,wg=new H,Tg=new H,Eg=new H,Dg=new U,Og=new U,kg=document.querySelector(`#stage`),Ag=document.querySelector(`#status`),jg=document.querySelector(`#frameStat`),Mg=document.querySelector(`#handStat`),Ng=document.querySelector(`#faceStat`),Pg=document.querySelector(`#avatarStat`),Fg=document.querySelector(`#dropHint`),Ig=document.querySelector(`#playPause`),Lg=document.querySelector(`#restart`),Rg=document.querySelector(`#speed`),zg=document.querySelector(`#motionScale`),Bg=document.querySelector(`#smoothing`),Vg=document.querySelector(`#vrmFile`),Q={frames:[],fps:29.97,frameWidth:720,frameHeight:480,elapsed:0,playing:!0,speed:1,motionScale:1,smoothing:.82,currentFrameIndex:0,vrm:null,motionReference:null},Hg={poseQuats:new Map,ikQuats:new Map,ikDirections:new Map,handAvoidance:new Map,expressionValues:new Map,rootPosition:null,filteredRow:null},Ug=new Ln;Ug.background=new q(15791344);var Wg=new _o(27,1,.1,100);Wg.position.set(0,1.48,2.35);var Gg=new du({canvas:kg,antialias:!0,alpha:!1,preserveDrawingBuffer:!0});Gg.setPixelRatio(Math.min(window.devicePixelRatio,2)),Gg.outputColorSpace=He;var Kg=new Su(Wg,Gg.domElement);Kg.target.set(0,1.43,0),Kg.enableDamping=!0,Kg.minDistance=1.7,Kg.maxDistance=5;var qg=new io(16777215,9805978,2.7);Ug.add(qg);var Jg=new wo(16777215,2.2);Jg.position.set(2,4,3),Ug.add(Jg);var Yg=new ri(new ua(1.45,64),new Gr({color:14674661,transparent:!0,opacity:.92}));Yg.rotation.x=-Math.PI/2,Yg.position.y=.015,Ug.add(Yg);var Xg=fv();Ug.add(Xg.group);var Zg=new Ru;Zg.register(e=>new ch(e)),window.addEventListener(`resize`,_v),window.addEventListener(`dragover`,e=>{e.preventDefault(),Fg.classList.add(`visible`)}),window.addEventListener(`dragleave`,()=>Fg.classList.toggle(`visible`,!Q.vrm)),window.addEventListener(`drop`,async e=>{e.preventDefault(),Fg.classList.toggle(`visible`,!Q.vrm);let t=e.dataTransfer?.files?.[0];t&&await o_(t)}),Ig.addEventListener(`click`,()=>{i_(!Q.playing)}),Lg.addEventListener(`click`,()=>{r_(0,!0)}),Rg.addEventListener(`input`,()=>{Q.speed=Number(Rg.value)}),zg.addEventListener(`input`,()=>{Q.motionScale=Number(zg.value)}),Bg.addEventListener(`input`,()=>{Q.smoothing=Number(Bg.value)}),Vg.addEventListener(`change`,async()=>{let e=Vg.files?.[0];e&&await o_(e)});async function Qg(){_v(),vv(`키포인트 로딩 중`),Q.frames=await $g(Hh),Q.fps=e_(Q.frames),Q.frameWidth=Q.frames[0]?.width??720,Q.frameHeight=Q.frames[0]?.height??480,Q.motionReference=t_(Q.frames),vv(`VRM 로딩 중`),await a_(),vv(Q.vrm?`VRM retarget 실행 중`:`debug skeleton 실행 중`),n_(),window.signMvp={setFrame:e=>r_(e,!0),inspectFrame:(e=Q.currentFrameIndex)=>nv(e),play:()=>i_(!0),pause:()=>i_(!1)},Gg.setAnimationLoop(l_)}async function $g(e){let t=await fetch(e);if(!t.ok)throw Error(`failed to load keypoints: ${t.status} ${e}`);let n=(await t.text()).split(`
`).map(e=>e.trim()).filter(Boolean).map(e=>JSON.parse(e));if(!n.length)throw Error(`keypoint file is empty`);return n}function e_(e){if(e.length<2)return 29.97;let t=e[0].time_ms,n=e[Math.min(30,e.length-1)].time_ms,r=Math.min(30,e.length-1);return 1e3/((n-t)/r)}function t_(e){let t=e.map(e=>w_(e.pose??[])).filter(Boolean);if(!t.length)return null;let n=t.reduce((e,t)=>(e.centerX+=t.center.x,e.centerY+=t.center.y,e.shoulderWidth+=t.shoulderWidth,e.torsoHeight+=t.torsoHeight,e),{centerX:0,centerY:0,shoulderWidth:0,torsoHeight:0}),r=t.length;return{center:{x:n.centerX/r,y:n.centerY/r},shoulderWidth:n.shoulderWidth/r,torsoHeight:n.torsoHeight/r}}function n_(){let e=new URLSearchParams(window.location.search),t=Number(e.get(`frame`));Number.isFinite(t)&&r_(t,!0),e.get(`paused`)===`1`&&i_(!1);let n=Number(e.get(`speed`));Number.isFinite(n)&&n>0&&(Q.speed=n,Rg.value=String(n))}function r_(e,t=!1){let n=$(Math.round(e),0,Math.max(0,Q.frames.length-1));Q.elapsed=n/Q.fps,Q.currentFrameIndex=n,t&&dv()}function i_(e){Q.playing=e,Ig.textContent=Q.playing?`Pause`:`Play`}async function a_(){try{await s_(Uh,`public/models/avatar.vrm`)}catch(e){console.warn(e),Fg.classList.add(`visible`),Pg.textContent=`debug skeleton`}}async function o_(e){let t=URL.createObjectURL(e);try{await s_(t,e.name)}finally{URL.revokeObjectURL(t)}}async function s_(e,t){Q.vrm&&=(Ug.remove(Q.vrm.scene),Rh.deepDispose(Q.vrm.scene),null);let n=(await Zg.loadAsync(e)).userData.vrm;if(!n)throw Error(`loaded model is not a VRM`);Rh.rotateVRM0(n),Rh.combineSkeletons(n.scene),Rh.combineMorphs(n),Z_(n),n.scene.position.set(0,0,0),Ug.add(n.scene),Q.vrm=n,dv(),Xg.group.visible=!1,Fg.classList.remove(`visible`),Pg.textContent=t}var c_=performance.now();function l_(e){let t=Math.min((e-c_)/1e3,.05);c_=e,Q.playing&&Q.frames.length&&(Q.elapsed+=t*Q.speed);let n=Q.frames.length/Q.fps;n>0&&(Q.elapsed%=n);let r=u_(Q.elapsed),i=r.index;Q.currentFrameIndex=i;let a=r.row,o=Q.vrm?g_(a,t):a;Q.vrm?(x_(Q.vrm,o,t),Q.vrm.update(t)):(Xg.group.visible=!0,pv(Xg,o)),gv(Q.frames[i],i),Kg.update(),Gg.render(Ug,Wg)}function u_(e){if(!Q.frames.length)return{index:0,row:null};let t=e*Q.fps,n=Math.floor(t)%Q.frames.length,r=(n+1)%Q.frames.length,i=t-Math.floor(t);return{index:n,row:d_(Q.frames[n],Q.frames[r],i)}}function d_(e,t,n){return{...e,pose:p_(e.pose,t.pose,n),face:p_(e.face,t.face,n),hands:f_(e.hands??[],t.hands??[],n),face_blendshapes:h_(e.face_blendshapes??{},t.face_blendshapes??{},n)}}function f_(e,t,n){let r=[],i=new Set([...e.map(e=>e.identity||e.handedness),...t.map(e=>e.identity||e.handedness)]);for(let a of i){let i=e.find(e=>(e.identity||e.handedness)===a),o=t.find(e=>(e.identity||e.handedness)===a),s=i||o;s&&r.push({...s,landmarks:p_(i?.landmarks,o?.landmarks,n)})}return r}function p_(e,t,n){return e?.length?!t?.length||e.length!==t.length?structuredClone(e):e.map((e,r)=>m_(e,t[r],n)):t?structuredClone(t):[]}function m_(e,t,n){let r={...e};for(let i of[`x`,`y`,`z`,`visibility`,`presence`])Number.isFinite(e?.[i])&&Number.isFinite(t?.[i])&&(r[i]=e[i]*(1-n)+t[i]*n);return r}function h_(e,t,n){let r={},i=new Set([...Object.keys(e),...Object.keys(t)]);for(let a of i){let i=Number.isFinite(e[a])?e[a]:0,o=Number.isFinite(t[a])?t[a]:i;r[a]=i*(1-n)+o*n}return r}function g_(e,t){if(!e)return e;if(!Q.playing||!Hg.filteredRow)return Hg.filteredRow=structuredClone(e),Hg.filteredRow;let n=b_(t),r=Hg.filteredRow,i={...e,pose:__(r.pose??[],e.pose??[],t,{baseAlpha:n*.48,fastAlpha:Math.min(1,n*.92),deadzone:1.6,fastDistance:40}),face:__(r.face??[],e.face??[],t,{baseAlpha:n*.52,fastAlpha:Math.min(1,n*1.05),deadzone:.7,fastDistance:18}),hands:v_(r.hands??[],e.hands??[],t,{baseAlpha:Math.min(1,n*.95),fastAlpha:Math.min(1,n*2.15),deadzone:.45,fastDistance:18}),face_blendshapes:h_(r.face_blendshapes??{},e.face_blendshapes??{},Math.min(1,n*1.25))};return Hg.filteredRow=i,i}function __(e,t,n,r){return e?.length?!t?.length||e.length!==t.length?structuredClone(t??e):t.map((t,i)=>y_(e[i],t,n,r)):t?structuredClone(t):[]}function v_(e,t,n,r){let i=[],a=new Set([...e.map(e=>e.identity||e.handedness),...t.map(e=>e.identity||e.handedness)]);for(let o of a){let a=e.find(e=>(e.identity||e.handedness)===o),s=t.find(e=>(e.identity||e.handedness)===o),c=s||a;c&&i.push({...c,landmarks:__(a?.landmarks,s?.landmarks,n,r)})}return i}function y_(e,t,n,r){if(!e||!t)return structuredClone(t??e);let i=$((ev(e,t)-r.deadzone)/Math.max(1,r.fastDistance-r.deadzone),0,1),a=1-$((Q.smoothing-.45)/.55,0,1)*.32,o=$(ov(r.baseAlpha,r.fastAlpha,i)*a,.05,.94),s={...t};for(let n of[`x`,`y`,`z`,`visibility`,`presence`])Number.isFinite(e[n])&&Number.isFinite(t[n])&&(s[n]=e[n]+(t[n]-e[n])*o);return s}function b_(e){let t=30*$(1.1-Q.smoothing*.45,.52,.9);return 1-Math.exp(-t*e)}function x_(e,t,n){S_(e,t,n);let r=T_(C_(t),n);e.humanoid.resetNormalizedPose(),e.humanoid.setNormalizedPose(r),e.humanoid.normalizedHumanBonesRoot.updateMatrixWorld(!0),O_(e,t,n),F_(e,t,n)}function S_(e,t,n){let r=w_(t.pose??[]),i=Q.motionReference;if(!r||!i)return;let a=new U($((r.center.x-i.center.x)/Math.max(1,i.shoulderWidth),-1,1)*og*Q.motionScale,$(-(r.center.y-i.center.y)/Math.max(1,i.torsoHeight),-1,1)*sg*Q.motionScale,$((i.shoulderWidth-r.shoulderWidth)/Math.max(1,i.shoulderWidth),-.8,.8)*cg);if(!Hg.rootPosition)Hg.rootPosition=a.clone();else{let e=sv(n,ov(ug,dg,$(Hg.rootPosition.distanceTo(a)/.14,0,1)));Hg.rootPosition.lerp(a,e)}e.scene.position.copy(Hg.rootPosition)}function C_(e){let t={},n=e.pose??[],r=Q.motionScale;return E_(t,n,r),D_(t,n,e.hands??[],r),P_(t,n,e.face??[],e.face_blendshapes??{},r),t}function w_(e){if(!av(e,[11,12,23,24]))return null;let t=iv(e[11],e[12]),n=iv(e[23],e[24]);return{center:{x:t.x*.68+n.x*.32,y:t.y*.74+n.y*.26},shoulderWidth:tv(e[11],e[12]),torsoHeight:Math.max(1,tv(t,n))}}function T_(e,t){let n={};for(let[r,i]of Object.entries(e)){let e=new H().fromArray(i.rotation),a=Hg.poseQuats.get(r);if(!a)a=e.clone(),Hg.poseQuats.set(r,a);else{let n=a.angleTo(e);a.slerp(e,uv(t,lv(r),n))}n[r]={rotation:a.toArray()}}return n}function E_(e,t,n){if(!av(t,[11,12,23,24]))return;let r=[t[11],t[12]],i=[t[23],t[24]],a=iv(r[0],r[1]),o=iv(i[0],i[1]),s=$((a.x-o.x)/185,-.24,.24)*n,c=$((a.y-o.y+165)/360,-.09,.14)*n;e[Z.Spine]=V_(c*.36,0,-s*.32),e[Z.Chest]=V_(c*.28,0,-s*.26)}function D_(e,t,n,r){for(let t of n){let n=t.identity||t.handedness;if(!qh[n])continue;let i=t.landmarks??[];if(!i.length)continue;let a=L_(i);for(let[t,o]of Object.entries(qh[n])){let s=a[t]??0,c=R_(i,t,n),l=Yh[t],u=n===`Left`?1:-1;o.forEach((i,a)=>{e[i]=z_(n,t,a,$(s*l.curl*l.weights[a]*r*Zh,0,1.35),a===0?c*l.spread*u*r:0,t===`thumb`?u*s*.16*r:0)})}}}function O_(e,t,n){k_(e,t.pose??[],t.hands??[],`Left`,{shoulder:11,elbow:13,wrist:15,upper:Z.LeftUpperArm,lower:Z.LeftLowerArm,hand:Z.LeftHand,middle:Z.LeftMiddleProximal},n),k_(e,t.pose??[],t.hands??[],`Right`,{shoulder:12,elbow:14,wrist:16,upper:Z.RightUpperArm,lower:Z.RightLowerArm,hand:Z.RightHand,middle:Z.RightMiddleProximal},n)}function k_(e,t,n,r,i,a){if(!av(t,[i.shoulder,i.elbow,i.wrist]))return;let o=e.humanoid.getNormalizedBoneNode(i.upper),s=e.humanoid.getNormalizedBoneNode(i.lower),c=e.humanoid.getNormalizedBoneNode(i.hand),l=e.humanoid.getNormalizedBoneNode(i.middle);if(!o||!s||!c)return;let u=W_(n,r),d=G_(n,r,a),f=u?.landmarks?.[0],p=f&&$_(f)?q_(f,d):null,m=p?Q_(t[i.wrist],p,.72):t[i.wrist],h=X_(t,t[i.elbow]),g=X_(t,m),_=h*eg*.72,v=g*eg+d.frontBoost,y=A_(t[i.shoulder],t[i.elbow],r,{frontBias:Xh+_,minZ:j_(h,.25),maxZ:.9}).clone(),b=A_(t[i.shoulder],m,r,{frontBias:Xh+v*.86,minZ:j_(g,.28),maxZ:.98}).clone(),x=y.lerp(b,lg).normalize(),S=A_(t[i.elbow],m,r,{frontBias:Xh+v,minZ:j_(g,.3),maxZ:1.04}).clone();if(M_(o,s,N_(`${r}:upperDir`,x,a,24),`${r}:upper`,a,15),e.humanoid.normalizedHumanBonesRoot.updateMatrixWorld(!0),M_(s,c,N_(`${r}:lowerDir`,S,a,28),`${r}:lower`,a,17),e.humanoid.normalizedHumanBonesRoot.updateMatrixWorld(!0),l&&u?.landmarks?.[9]&&$_(u.landmarks[9])){let n=q_(u.landmarks[9],d),i=X_(t,n),o=A_(m,n,r,{frontBias:.2+(i*tg+d.frontBoost),minZ:j_(i,.18),maxZ:.9,lateral:r===`Left`?-.02:.02}).clone();M_(c,l,N_(`${r}:palmDir`,o,a,30),`${r}:hand`,a,18),e.humanoid.normalizedHumanBonesRoot.updateMatrixWorld(!0)}}function A_(e,t,n,r={}){let i=Q.motionScale,a=(t.x-e.x)/120,o=-(t.y-e.y)/120,s=-((t.z??0)-(e.z??0))*.55,c=r.lateral??(n===`Left`?-.04:.04),l=$(s+(r.frontBias??Xh),r.minZ??.24,r.maxZ??.72);return Dg.set(a+c,o,l).normalize().multiplyScalar(i)}function j_(e,t){return ov(t,ng,$(e/.42,0,1))}function M_(e,t,n,r,i,a=16){if(!e.parent||!t)return;let o=Og.copy(t.position).normalize();if(o.lengthSq()<1e-5)return;let s=e.getWorldQuaternion(wg),c=o.clone().applyQuaternion(s).normalize(),l=Tg.setFromUnitVectors(c,n.clone().normalize()).multiply(s),u=e.parent.getWorldQuaternion(Sg).invert().multiply(l),d=Hg.ikQuats.get(r);d||(d=u.clone(),Hg.ikQuats.set(r,d));let f=d.angleTo(u);d.slerp(u,uv(i,a,f)),e.quaternion.copy(d),e.updateMatrixWorld(!0)}function N_(e,t,n,r){let i=t.clone().normalize(),a=Hg.ikDirections.get(e);if(!a)return a=i.clone(),Hg.ikDirections.set(e,a),a.clone();let o=a.angleTo(i),s=$(sv(n,r)+o*.16,.08,.94);return a.lerp(i,s).normalize(),a.clone()}function P_(e,t,n,r,i){if(!av(t,[11,12]))return;let a=r.jawOpen??0,o=Math.max(r.mouthSmileLeft??0,r.mouthSmileRight??0),s=r.browInnerUp??0,c=Math.max(r.browDownLeft??0,r.browDownRight??0),l=$((o-c)*.04,-.05,.05)*i,u=0,d=$(a*.1-s*.05+c*.04,-.08,.12)*i;if(n.length>263&&av(n,[33,263,1])){let e=iv(n[33],n[263]);u=$((n[1].x-e.x)/220,-.08,.08)*i,d+=$((n[1].y-e.y-36)/360,-.04,.05)*i}e[Z.Head]=V_(d,u,-l)}function F_(e,t,n){let r=e.expressionManager;if(!r)return;r.resetValues();let i=t.face_blendshapes??{},a=$((Math.max(i.eyeBlinkLeft??0,i.eyeBlinkRight??0)-.68)/.24,0,1),o=i.jawOpen??0,s=Math.max(i.mouthSmileLeft??0,i.mouthSmileRight??0),c=Math.max(i.mouthPucker??0,i.mouthFunnel??0);I_(r,`blink`,$(a,0,1),n),I_(r,`happy`,$(s*.9,0,.8),n),I_(r,`aa`,$(o*1.7,0,1),n),I_(r,`oh`,$(c*1.2,0,.9),n)}function I_(e,t,n,r){let i=sv(r,20),a=Hg.expressionValues.get(t)??n,o=a+(n-a)*i;Hg.expressionValues.set(t,o),e.setValue(t,o)}function L_(e){let t={};for(let[n,r]of Object.entries(Jh)){let[i,a,o,s]=r.map(t=>e[t]);!i||!a||!o||!s||(t[n]=$((B_(i,a,o)+B_(a,o,s)-.55)/2.15,0,1.15))}return t}function R_(e,t,n){let r=Jh[t];if(!r||!av(e,[0,r[0]]))return 0;let i=H_(e[0],e[r[0]]),a=H_(e[0],e[9]??e[0]),o=n===`Left`?1:-1;return $(U_(i-a)*o,-.8,.8)}function z_(e,t,n,r,i,a){let o=e===`Left`?-1:1,s=t===`thumb`?$(r*.9,0,1.05):r,c=new H;return c.multiply(wg.setFromAxisAngle(Dg.set(0,0,1),s*o)),n===0&&i&&c.multiply(Tg.setFromAxisAngle(Og.set(0,1,0),i)),t===`thumb`&&c.multiply(Eg.setFromAxisAngle(Dg.set(1,0,0),a)),{rotation:c.toArray()}}function B_(e,t,n){let r=e.x-t.x,i=e.y-t.y,a=n.x-t.x,o=n.y-t.y,s=r*a+i*o,c=Math.hypot(r,i)*Math.hypot(a,o);return c<1e-5?0:Math.PI-Math.acos($(s/c,-1,1))}function V_(e,t,n){return Cg.set(e,t,n,`XYZ`),Sg.setFromEuler(Cg),{rotation:[Sg.x,Sg.y,Sg.z,Sg.w]}}function H_(e,t){return Math.atan2(-(t.y-e.y),t.x-e.x)}function U_(e){let t=e;for(;t>Math.PI;)t-=Math.PI*2;for(;t<-Math.PI;)t+=Math.PI*2;return t}function W_(e,t){return e.find(e=>(e.identity||e.handedness)===t)}function G_(e,t,n){let r=W_(e,t),i=e.find(e=>(e.identity||e.handedness)&&(e.identity||e.handedness)!==t),a=J_(r),o=J_(i);if(!a||!o)return K_(t,{x:0,y:0,frontBoost:0,closeWeight:0},n);let s=a.x-o.x,c=a.y-o.y,l=Math.hypot(s,c);l<1&&(s=t===`Left`?-1:1,c=0,l=1);let u=$((rg-l)/rg,0,1);if(u<=0)return K_(t,{x:0,y:0,frontBoost:0,closeWeight:0},n);let d=s/l,f=c/l,p=Math.max(0,ig-l)*.64+u*16,m=Y_(r)<=Y_(i);return K_(t,{x:d*p,y:f*p*.38,frontBoost:m?u*ag:u*.04,closeWeight:u},n)}function K_(e,t,n){let r=Hg.handAvoidance.get(e);if(!r)return r={...t},Hg.handAvoidance.set(e,r),{...r};let i=sv(n,t.closeWeight>r.closeWeight?24:14);return r.x+=(t.x-r.x)*i,r.y+=(t.y-r.y)*i,r.frontBoost+=(t.frontBoost-r.frontBoost)*i,r.closeWeight+=(t.closeWeight-r.closeWeight)*i,{...r}}function q_(e,t){return{...e,x:e.x+t.x,y:e.y+t.y}}function J_(e){let t=(e?.landmarks??[]).filter($_);return t.length?{x:t.reduce((e,t)=>e+t.x,0)/t.length,y:t.reduce((e,t)=>e+t.y,0)/t.length}:null}function Y_(e){let t=[0,5,9,13,17].map(t=>e?.landmarks?.[t]?.z).filter(Number.isFinite);return t.length?t.reduce((e,t)=>e+t,0)/t.length:0}function X_(e,t){if(!t||!av(e,[11,12,23,24]))return 0;let n=iv(e[11],e[12]),r=iv(e[23],e[24]),i=tv(e[11],e[12]),a=i*.58,o=n.y-i*.16,s=r.y+i*.42,c=Math.max(1,s-o),l=Math.abs(t.x-n.x)/Math.max(1,a),u=$((t.y-o)/c,0,1),d=t.y>=o&&t.y<=s,f=$(1-l,0,1),p=Math.sin(u*Math.PI),m=d?f*p*Qh:0,h=0;if(e[0]&&$_(e[0])){let n=i*.38,r=i*.5,a={x:e[0].x,y:e[0].y+i*.12};h=$(1-Math.hypot((t.x-a.x)/Math.max(1,n),(t.y-a.y)/Math.max(1,r)),0,1)*$h}return $(m+h,0,.42)}function Z_(e){let t=e.springBoneManager;if(!t?.joints)return;let n=!1;for(let e of t.joints)!(e.bone?.name?.toLowerCase()??``).includes(`hair`)||!e.settings||(e.settings.stiffness=Math.max(e.settings.stiffness??0,gg),e.settings.dragForce=Math.max(e.settings.dragForce??0,_g),e.settings.gravityPower=Math.min(e.settings.gravityPower??0,vg),e.settings.hitRadius=Math.max(e.settings.hitRadius??0,yg),n=!0);n&&t.reset()}function Q_(e,t,n){return{x:e.x*(1-n)+t.x*n,y:e.y*(1-n)+t.y*n,z:Number.isFinite(e.z)&&Number.isFinite(t.z)?e.z*(1-n)+t.z*n:t.z??e.z??0}}function $_(e){return Number.isFinite(e?.x)&&Number.isFinite(e?.y)}function ev(e,t){if(!e||!t)return 0;let n=Number.isFinite(e.z)&&Number.isFinite(t.z)?(t.z-e.z)*180:0;return Math.hypot((t.x??0)-(e.x??0),(t.y??0)-(e.y??0),n)}function tv(e,t){return Math.hypot((t.x??0)-(e.x??0),(t.y??0)-(e.y??0))}function nv(e){let t=$(Math.round(e),0,Math.max(0,Q.frames.length-1));return{index:t,hands:(Q.frames[t]?.hands??[]).map(e=>{let t=e.identity||e.handedness;return{side:t,curls:L_(e.landmarks??[]),rotations:rv(t)}})}}function rv(e){if(!Q.vrm||!qh[e])return{};let t={};for(let[n,r]of Object.entries(qh[e]))t[n]=r.map(e=>{let t=Q.vrm.humanoid.getNormalizedBoneNode(e);return t?t.quaternion.toArray().map(e=>Number(e.toFixed(4))):null});return t}function iv(e,t){return{x:(e.x+t.x)/2,y:(e.y+t.y)/2,z:((e.z??0)+(t.z??0))/2}}function av(e,t){return t.every(t=>e?.[t]&&Number.isFinite(e[t].x)&&Number.isFinite(e[t].y))}function $(e,t,n){return Math.min(n,Math.max(t,e))}function ov(e,t,n){return e+(t-e)*n}function sv(e,t){let n=t*cv();return 1-Math.exp(-n*e)}function cv(){return $(1.25-Q.smoothing*.75,.35,.95)}function lv(e){return bg.has(e)?fg:e===Z.Head?pg:xg.has(e)?mg:hg}function uv(e,t,n){return $(sv(e,t)+$(n*.045,0,.16),.025,.72)}function dv(){Hg.poseQuats.clear(),Hg.ikQuats.clear(),Hg.ikDirections.clear(),Hg.handAvoidance.clear(),Hg.expressionValues.clear(),Hg.rootPosition=null,Hg.filteredRow=null,Q.vrm?.springBoneManager?.reset()}function fv(){let e=new kn,t=new Ri({color:6192038}),n=new Ri({color:8361669}),r=new Gr({color:15914685}),i=new jr,a=new jr,o=Array.from({length:120},()=>{let t=new ri(new fa(.018,10,10),r);return e.add(t),t}),s=new Xi(i,t),c=new Xi(a,n);return e.add(s,c),{group:e,bodyGeometry:i,handGeometry:a,points:o}}function pv(e,t){let n=[];for(let e of Gh)for(let r=0;r<e.length-1;r++){let i=t.pose?.[e[r]],a=t.pose?.[e[r+1]];i&&a&&n.push(hv(i),hv(a))}let r=[],i=[];for(let e of t.hands??[]){for(let[t,n]of Kh){let i=e.landmarks?.[t],a=e.landmarks?.[n];i&&a&&r.push(hv(i),hv(a))}for(let t of e.landmarks??[])i.push(hv(t))}mv(e.bodyGeometry,n),mv(e.handGeometry,r),e.points.forEach((e,t)=>{let n=i[t];e.visible=!!n,n&&e.position.copy(n)})}function mv(e,t){let n=new Float32Array(t.length*3);t.forEach((e,t)=>{n[t*3]=e.x,n[t*3+1]=e.y,n[t*3+2]=e.z}),e.setAttribute(`position`,new gr(n,3)),e.computeBoundingSphere()}function hv(e){let t=2.2/Q.frameHeight;return new U((e.x-Q.frameWidth*.66)*t,(Q.frameHeight*.88-e.y)*t,-.2+$((e.z??0)*.25,-.45,.45))}function gv(e,t){jg.textContent=`${t+1} / ${Q.frames.length}`,Mg.textContent=`${e.hands?.length??0}`,Ng.textContent=e.face?.length?`tracked`:`missing`}function _v(){let e=kg.getBoundingClientRect(),t=Math.max(1,e.width),n=Math.max(1,e.height);Wg.aspect=t/n,Wg.updateProjectionMatrix(),Gg.setSize(t,n,!1)}function vv(e){Ag.textContent=e}Qg().catch(e=>{console.error(e),vv(e.message),Fg.classList.add(`visible`)});